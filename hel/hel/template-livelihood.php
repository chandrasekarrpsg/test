<?php 
/* Template Name: Template - Livelihood */
...
<div class="lifehoodsec2 lifehoopage">
	<div class="banitm">
		<div class="lifehoodrt d-lg-block d-md-none d-sm-none d-none">
			<img src="<?= SITE_URL; ?>admin/post_img/<?= $get_page_details_row['page_image'];?>" alt=""/>
		</div>
		<div class="container">
			<img src="<?= SITE_URL; ?>admin/post_img/<?= $get_page_details_row['page_image'];?>" alt="" class="d-lg-none d-md-block d-sm-block d-block"/>
			<div class="boxsa heading2">
