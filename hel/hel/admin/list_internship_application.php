...
function delconfirm(cid)
{
	...
	if(c==true)
	{
	location.href="job_application.php?type=list_internship_application&action=deleteinternshipapplication&<?php echo function_session_name().'='.function_session_id();?>&application_id="+cid+"&lp=usr";
	...
	return false;
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>List Internship Application </h2>
                ...
                <div class="x_content">
                  ...
                  <?php
$list_cat_sql = "SELECT * FROM tbl_internship_application order by application_id desc";
...
<td>					
	 ...
	 <a class="btn btn-info btn-xs" href="job_application.php?type=view_internship_application&lp=ac&application_id=<?php print $list_cat['application_id']; ?>&<?php echo session_name().'='.session_id();?>">Edit</a>	
