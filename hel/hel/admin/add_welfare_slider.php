...
<div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="add_welfare_slider_form" action="" method="post" name="add_welfare_slider_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
 							<input type="file" name="welfare_banner_image" id="welfare_banner_image" value="" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div>
                    <!-- <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
 							<input type="file" name="welfare_banner_logo" id="welfare_banner_logo" value="" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div> -->
                     <div class="item form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
                      	...
                      	<input type="submit" name="save_welfare_slider" value="Save" onclick="return validate_form('add_welfare_slider_form');" class="btn btn-success btn-submit">
