...
<?php
	...
	//echo $sql;
		...
		if($result){
			...
			$to	 		= $admin_email;
			$subject	=  "HEL New Admin Password";
			$massege_body 		= "
			<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr><td>Hi</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td>You Ask for new password for HEL admin panel</td></tr>
			...
			<tr><td>".$massege_body."</td></tr>
				...
				if($send)
				{
					 $loginmessage = "Your Password is send to your email address";
				}		
      ...
      <div id="login" class="animate form">
        <section class="login_content">
          <form method="post" class="cmxform" id="form1" name="form1" action="<?php echo $_SERVER['PHP_SELF'];?>">
			...
			<span style="margin-left:30px;"><?php echo $loginmessage;?></span>
			</div>
		 ...
		 <?php } ?>
            ...
            <div>
              ...
              <a class="reset_pass" href="login.php?forgot">Retrieve your password?</a>
            </div>
            ...
            <div class="separator">
              ...
              <div>
                ...
                <p>©<?=  date('Y'); ?> All Rights Reserved. HEL</p>
              </div>
            </div>
          </form>
          <!-- form -->
