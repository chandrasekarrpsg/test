...
$sl = 'SELECT * FROM  tbl_esg WHERE esg_id = "'.$esg_id.'"';
...
<div class="x_panel">
               ...
               <h2>Edit ESG </h2>
                ...
                <div class="x_content">
                  ...
                  <form id="edit_esg_form" action="" method="post" name="edit_esg_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                  ...
                  <!-- 	<div class="item form-group">
                    ...
                    <!-- <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
 <input type="text" name="esg_title" id="esg_title" class="form-control col-md-7 col-xs-12" value="<?php echo stripslashes(html_entity_decode($rc['esg_title']));?>" required="required" />
                      </div>
                    </div>
 ...
 <img src="post_img/<?php print $rc['esg_image'];?>" height="100" width="100" />
 ...
 <input type="file" name="esg_image" id="esg_image" class="form-control col-md-7 col-xs-12" value=""   />
                      </div>
                    </div>
 ...
 <img src="esg_img/<?php print $rc['esg_image_webp'];?>" height="100" width="100" />
 ...
 <input type="file" name="esg_image_webp" id="esg_image_webp" class="form-control col-md-7 col-xs-12" value=""   />
             ...
             <!-- <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="esg_date" id="datepicker" value="<?php echo stripslashes(html_entity_decode($rc['esg_date']));?>" required="required" id="esg_date" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div>-->    
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="esg_srt_desc" required="required" id="esg_srt_desc" class="form-control col-md-7 col-xs-12"><?php echo stripslashes(html_entity_decode($rc['esg_srt_desc']));?></textarea>
                      </div>
                    </div>
		...
		<?php
			...
			$oFCKeditor->Value		= htmlspecialchars_decode($rc['esg_desc']);
			$oFCKeditor->Create() ;
		?>
		</div>
                </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="esg_link" required="required" id="esg_link" class="form-control col-md-7 col-xs-12"  value="<?php echo $rc['esg_link'];?>"/>
                      </div>
                    </div>
                    <!-- <div class="item form-group">
 ...
 <input type="radio" name="show_home" id="show_home" class="flat" value="1" <?php if( $rc['show_home']==1){ echo "checked";}?> />Yes
  ...
  <input type="radio" name="show_home" id="show_home" class="flat" value="0" <?php if($rc['show_home']==0){ echo "checked";}?> />No
                  ...
                  <input type="hidden" name="esg_id" value="<?php print $rc['esg_id']; ?>" />
                      	
                      			
	
                      	
                      	<input type="submit" name="edit_esg" value="Update" onclick="return validate_form('edit_esg_form');" class="btn btn-success btn-submit">
