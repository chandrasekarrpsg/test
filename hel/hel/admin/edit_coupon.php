...
<div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="add_coupon_form" action="" method="post" name="add_coupon_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                     ...
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" >Coupon Code <span class="required">*</span>
                      </label>
			...
			?>				
                    ...
                    <!-- <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" >Coupon Type <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="radio" name="coupon_type" value="1" <?php if($edit_row['coupon_type']==1){echo 'checked';}else{} ?>/> Percentage(%)
									<input type="radio" name="coupon_type" value="0" <?php if($edit_row['coupon_type']==0){echo 'checked';}else{} ?> /> Fixed Value
                      </div>
                    </div> -->
                    
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" >Coupon Discount <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
