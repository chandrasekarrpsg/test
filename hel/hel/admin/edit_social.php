                ...
                <div class="x_content">
                  ...
                  <form id="edit_social_form" action="" method="post" name="edit_social_form" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                   ...
                   <div class="item form-group">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="social_twitter">Instagram <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <!-- <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="social_twitter">youtube <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="social_twitter">Linkdin <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="social_linkedin" id="social_linkedin" value="<?php echo $social_Res['social_linkedin'];?>" class="form-control col-md-7 col-xs-12" placeholder="Linkdin Link" required="required" />
                      </div>
                    </div>
                    
                    
                    <!-- <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="social_twitter">Whatsapp <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="social_dribble" id="social_dribble" value="<?php echo $social_Res['social_dribble'];?>" class="form-control col-md-7 col-xs-12" placeholder="Whatsapp Link" required="required" />
                      </div>
                    </div>  -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="social_pinterest" id="social_google" value="<?php echo $social_Res['social_pinterest'];?>" class="form-control col-md-7 col-xs-12" placeholder="Pinterest Link" required="required" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
						...
						<input name="save_social" type="hidden" value="submit" />
                        <input type="button" name="save_social_btn" value="submit" onclick="return validate_form('edit_social_form');" class="btn btn-success btn-submit">
