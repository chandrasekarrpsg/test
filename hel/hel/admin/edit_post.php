...
<div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <!-- 	<div class="item form-group">
                    ...
                    <!-- <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
 <input type="text" name="post_title" id="post_title" class="form-control col-md-7 col-xs-12" value="<?php echo stripslashes(html_entity_decode($rc['post_title']));?>" required="required" />
                      </div>
                    </div>
 ...
 <img src="post_img/<?php print $rc['post_image'];?>" height="100" width="100" />
 ...
 <img src="post_img/<?php print $rc['post_image_webp'];?>" height="100" width="100" />
 ...
 <input type="file" name="post_image_webp" id="post_image_webp" class="form-control col-md-7 col-xs-12" value=""   />
             ...
             <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="post_date" id="datepicker" value="<?php echo stripslashes(html_entity_decode($rc['post_date']));?>" required="required" id="post_date" class="form-control col-md-7 col-xs-12"  />
                      </div>
                    </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="post_srt_desc" required="required" id="post_srt_desc" class="form-control col-md-7 col-xs-12"><?php echo stripslashes(html_entity_decode($rc['post_srt_desc']));?></textarea>
                      </div>
                    </div>
