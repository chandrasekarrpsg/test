<footer class="footersec">
	<div id="block" data-video-urls="<?= SITE_URL; ?>assets/video/HELNIGHT.webm,<?= SITE_URL; ?>assets/video/HELNIGHT.mp4" data-autoplay="true" data-loop="true" data-wf-ignore="true" class="background-video w-background-video w-background-video-atom">
		<video autoplay="" loop="" style="" muted="" playsinline="" data-wf-ignore="true">
			<source src="<?= SITE_URL; ?>assets/video/HELNIGHT.webm" data-wf-ignore="true"/>
			<source src="<?= SITE_URL; ?>assets/video/HELNIGHT.mp4" data-wf-ignore="true"/>
		</video>
		<div class="footcont">
			<div class="foottop">
				<div class="container">
					<div  class="row">
						<div class="col-md-6 col-sm-12">
							<div  class="row">
								<div class="col-sm-6 footbox">
									<h4>ESG</h4>
									<ul>
										<li><a href="<?= SITE_URL; ?>environmental_management.php">Environment Management</a></li>   
								...
								<div class="col-sm-6 footbox">
									<h4>Quick Links</h4>
									<ul>
										<li><a href="<?= SITE_URL; ?>plant.php">About HEL</a></li>   
										...
										<li><a href="<?= SITE_URL; ?>contactus.php">Contact Us</a></li> 
										<li><a href="<?= SITE_URL; ?>page.php?alise=terms-of-use">Terms of Use</a></li>   
										<li><a href="<?= SITE_URL; ?>daily-schedule.php">Download</a></li>  
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 fotrt">
							
							<?= $widget_rows['foot_content'];?>
						</div>
					</div>
				</div>
			</div>
...
<script src="<?= SITE_URL; ?>assets/js/wow.script.js"></script>
<script src="<?= SITE_URL; ?>assets/js/demo.js"></script>
<script src="<?= SITE_URL; ?>assets/js/jquery.jsscroll.js"></script>
<script src="<?= SITE_URL; ?>assets/js/lazysizes.min.js"></script>
<script src="<?= SITE_URL; ?>assets/js/jquery.fancybox.js"></script>
<script src="<?= SITE_URL; ?>assets/js/jquery.mousewheel-3.0.6.pack.js"></script>
<script src="<?= SITE_URL; ?>assets/js/jquery.fancybox-media.js"></script>
<script src="<?= SITE_URL; ?>assets/js/videopopup.js"></script>
<script src="<?= SITE_URL; ?>assets/js/jquery-ui.js"></script>
<script src="<?= SITE_URL; ?>assets/js/viewdatepicker.js"></script>
