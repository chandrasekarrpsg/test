...
<% if(scmp_clause.equals("Y")){ %>
       If there is any fatal, lost work day case(lwdc), violation of safe work practices and non-availability of required quality PPEs and safety
gadgets found related to this job, penalization according to CESC Ltd's present Safety consequence management policy will be applicable.
    <% } %>
      </font>
      </div></td>
      </tr>
