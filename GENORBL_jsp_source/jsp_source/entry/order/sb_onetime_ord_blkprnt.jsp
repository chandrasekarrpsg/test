...
try{
 ...
 qry =   "  select						  " +
         ...
         other_consumables     = rs.getString(41);
         order_tax_type        = rs.getString(42);
...
<body onload = "javascript:mmprint();javascript:cls();"> 
...
%>
<div align="center" id="secondPage" style="width: 967px;">
<table border="0" cellpadding="0" cellspacing="0" width="80%" style="border-collapse: collapse;" bordercolor="#111111">
