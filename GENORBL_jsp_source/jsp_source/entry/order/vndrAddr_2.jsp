    ...
    <head>
        ...
        <script LANGUAGE="javascript">
            ...
            function rollon(j){
                ...
                eval("td_"+(j+5)+"_"+"2"+".style.backgroundColor=\"yellow\"")
                document.getElementById("td_"+(j+5)+"_2").innerHTML='<font face="Times New Roman" color="black" size="2">GST Registration No. : '+sVndrAddr_6[j]+'</font>';;
                /*}else{
                    eval("td_"+(j-4)+"_"+"2"+".style.backgroundColor=\"yellow\"")
            ...
            function rollout(j){
                ...
                eval("td_"+(j+5)+"_"+"2"+".style.backgroundColor=\"lavender\"")
                document.getElementById("td_"+(j+5)+"_2").innerHTML="&nbsp;";
                /*}else{
            ...
            function getVndrConf(x,y,z){ 
                ...
                ordUpdConfXML.onreadystatechange = function(){
                    if(ordUpdConfXML.readyState == 4){
                        ...
                        var cell2 = myval[1].childNodes[0].nodeValue;
                    
                        if(cell == 'Y' && cell2 == 'Y'){
                            rowclick(x,y,z)
                        }else if(cell == 'Y' && cell2 == 'N'){
                            flag = confirm('GST Registration No. is not available for the selected vendor !');

                            if(flag == true){
                                rowclick(x,y,z)
                            }
                        }else if(cell == 'N' && cell2 == 'Y'){
                            flag = confirm('First time order for this vendor in the Present System.Please check Vendor Name & Address !');

                            if(flag == true){
                                rowclick(x,y,z)
                            }
                        }else if(cell == 'N' && cell2 == 'N'){
                            flag = confirm('First time order for this vendor in the Present System.Please check Vendor Name & Address & GST Registration No. is not available for the selected vendor !');
    ...
    <body  text="#000000" bgcolor="#FFFFFF" onbeforeunload="terminate();">
        ...
        <center>
            <table  width="90%" border="0" style = "border : 1pt solid red ; border-collapse : collapse" bgcolor="lavender" cellspacing="0" cellpadding="0" bordercolor="#002851" bordercolorlight="#C0C0C0" bordercolordark="#002851">
                ...
                <tr  id="tr_<%= i%>" onmouseout="rollout(<%=i%>)" onmouseover="rollon(<%=i%>)" onclick="return getVndrConf('<%=sVndrCd%>','<%=sVndrNm%>','<%=sWageLiab%>')">
