...
%>
      <td width="25%" class="style3" align="center" colspan="2">
        <input type="submit" name="b1" id="b1" value="Save" class="style3" onclick="return selectCase('<%=refId%>');" />
      </td>
<%
}
else {
%>
      <td width="25%" class="style3" align="center" colspan="2">
        <input type="submit" name="b1" id="b1" value="Save" class="style3" disabled onclick="return selectCase('<%=refId%>');" />
      </td>
<%
}
%>
      <td width="25%" class="style3" align="center" colspan="2">
        <input type="button" name="btnExl" id="btnExl" value="Export To Excel" class="style3" onclick="window.open('bill_spbill_selection_pg_xls.jsp?refId=<%=refId%>&stncd=<%=stncd%>')" />
      </td>
      <td width="25%" class="style1" align="center" colspan="2"></td>
      </tr>
      </table>
...
<div id="divupd" class="hide"  style="width: 0px; height: 0px">
<iframe name="ifrdivupd" src="bill_spbill_selection_pg_upd.jsp?D0=0" class="autoHeight" width="100%" height="100%" scrolling="auto"
frameborder="1">
</iframe>
</div>
