...
<%  response.setHeader("Content-Disposition", "attachment; filename=darewise_bill_sent_to_finance.xls");%>
...
<%
         ...
         finally{System.out.println(" CCCCCC datewise_bill_sent_fin_qry_xls.jsp CLOSED !!!"); mk.con.close(); }
