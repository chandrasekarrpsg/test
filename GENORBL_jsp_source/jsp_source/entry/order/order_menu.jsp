...
.style4 {
      ...
      */
            ...
            function pageSubt(no){
                if(no == 1){
                    ...
                    formPageSubt.action = "bill_entry.jsp";
                    formPageSubt.submit();
                }else if(no == 4){
                    formPageSubt.action = "bill_list.jsp";
                    formPageSubt.submit();
                }else if(no == 5){
                    /*formPageSubt.copy.value = 'VENDOR';
    ...
    <body bgcolor="#ece9d8" onload="preScript();">
        <ul class="menu1">
            ...
            <li>
                <div id="liOrdSrch" style ="width : 140px ;visibility : hidden">
            ...
            <li>
                <div id="liPrntOrd" style ="width : 120px ;visibility : hidden" onmouseover="document.getElementById('pBx').style.visibility='visible';document.getElementById('iBx').style.visibility='hidden';">
