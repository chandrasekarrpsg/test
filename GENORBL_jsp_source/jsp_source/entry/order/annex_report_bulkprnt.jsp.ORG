...
<table border="0" cellspacing="1" cellpadding="0" width="80%">
  ...
  <tr>
     <td align ="left"> <font face="Verdana" size="2"><strong>Ref: <%=order_no%></strong></font></td>
     <td align ="right"><font face="Verdana" size="2"><strong>Date: <%=order_dt%></strong></font></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp; </td>
  </tr>
  <tr>
    <td colspan="2" valign="top">
       <font face="Verdana">
         <div id="annex" name="annex"  style=" font-family: Verdana; font-size: 16px; width:800px; text-align: justify;" ><%=annex%></div>
       </font>
    </td>
  </tr>
