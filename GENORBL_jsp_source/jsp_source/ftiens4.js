...
{ 
  ...
  //alert('fold');
	...
	//  docW = docW + "<a href='" + this.hreference + "' TARGET=\"basefrm\" "
	    docW = docW + "<a href=\"javascript:alert('fold')\" "
	   }
	else
	   {
	//   alert('2');
	//  docW = docW + "<a href= blank.html target='I1' "
        docW = docW + "<a href=\"javascript:go_to_page('"+this.hreference+"')\" "
...
function go_to_page(target)
        ...
        if(target != 'ccccc')
          {
             if(target=='SEARCH VENDOR')
             window.open('vendor_search_frame.jsp','SEARCH','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='ADD NEW VENDOR')
             window.open('vendor_entry_frame.jsp','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='VENDORS')
             window.open('vendor_entry_frame.jsp?frmAdm=CD','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='VENDOR MANAGEMENT')
             window.open('vendor_entry_frame.jsp?frmAdm=VP','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='VENDOR DOCUMENT UPLOADING')
             window.open('vendor_entry_frame.jsp?frmAdm=DU','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='SEARCH SPECIAL BILL')
             window.open('spbill_search_frame.jsp','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='ADD SPECIAL BILL')
             window.open('spbill_entry_frame.jsp','ENTRY','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1,titlebar=0,location=0') ;

             if(target=='LIST OF BILLS RELEASED (*)')
             window.open('bill_rlzd_dptwz.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='COMPONENTS OF BILLS (*)')
             window.open('bill_cmpnts_vndrwz.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='VENDORWISE BILLS RELEASED(*)')
             window.open('bill_order_vndrwz.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='BILL LIABILTY (CONTRACTS)')
             window.open('bill_liability.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='FINYR WISE ANNEXURES')
             window.open('bill_annex_index.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='ORDERS HAVING PNDNG BILLS(*)')
             window.open('bill_pending.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='CONTRACTOR-WISE CASH FLOW')
             window.open('bill_contractor.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='RANKING OF VENDORS (*)')
             window.open('bill_rnkng_vendors.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='MAJOR JOBS(ONETIME ORD.)(*)')
             window.open('bill_major_jobs.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='DELAY OF ORDERS AND BILLS (*)')
             window.open('bill_delay_index.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='BILLS NOT RCVD. AT FINANCE(*)')
             window.open('bill_not_rcvd.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

 
             if(target=='DASHBOARD')
             window.open("budget_dash_main.jsp","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

             if(target=='PRINT ORDER')
             window.open("order_frame_spl_emp.jsp?sPgTyp=entry","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");
             if(target=='ADD NEW ORDER')
             window.open("order_frame.jsp?sPgTyp=entry","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");
             if(target=='SEARCH ORDER')
             window.open("order_frame.jsp?sPgTyp=search","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

             if(target=='ALLOW BILL RELEASE')
             window.open("order_frame.jsp?sPgTyp=blReal","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

             if(target=='PASSWORD RESET')
             window.open('passwd_reset.jsp') ;

             if(target=='EMPLOYEE INFO.')
             window.open('doUpdEmp.jsp') ;

             if(target=='EMPLOYEE INFO')
             window.open('doUpdEmp_local.jsp') ;

             if(target=='ACCESS CONTROL')
             window.open('doChangeAccessLevel.jsp') ;

             if(target=='BILL FREQUENCY')
             window.open('doChangeBillFreq.jsp') ;

             if(target=='LOOKUP TABLES')
             window.open('doUpdLookupTables.jsp') ;

             if(target=='SEND BILLS TO FINANCE')
             window.open('batch_proc_fin_rcv_dt_front.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='DATEWISE BILLS SEND TO FINANCE')
             window.open('datewise_bill_sent_to_fin.jsp','_parent','height=' + screen.height + ',width=' + screen.width + ',toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1') ;

             if(target=='BUDGET ENTRY')
             window.open("gen_new_entry.jsp","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

            if(target=='REPORTS')
            window.open("submenu_budget_mon_reports.jsp","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

            if(target=='DATA UPDATION')
            window.open("submenu_budget_mon_updation.jsp","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

             if(target=='MAXIMUM NO. OF BILLS')
             window.open("doUpdMaxNoBls.jsp?sPgTyp=search","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");

             if(target=='REVOKE CANCELLED ORDER')
             window.open('doRvkCnclOrdr.jsp') ;

             if(target=='CHANGE ORDER STATUS')
             window.open('doUpdOrdrStats.jsp') ;

             if(target=='VENDOR EVALUATION RATINGS')
             window.open('doUpdVndEvalRtngs.jsp') ;

             if(target=='DEPARTMENT MATRIX')
             window.open('LoginDeptOrdDeptMatrix.jsp') ;

             if(target=='UNLOCK BILL')
             window.open('doUnlockBl.jsp') ;

             if(target=='CANCEL BILL')
             window.open('doCancelBl.jsp') ;

            if(target=='KAIZEN')
            window.open("ipicms_frame.jsp","mainWin","toolbar=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,fullscreen=1");
