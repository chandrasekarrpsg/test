...
if(y==0){
  if(x==0){
   ...
   //alert(parameter);
   window.open("gen_rej_all_upd_insrt.jsp?"+parameter,"_self");
  }
}else{
    return false;
}
...
<b><font face="Book Antiqua" color="#800000" size="3">REJECTION FORM OF <%=station%> FOR FINANCIAL YEAR <%=finyr1%></font></b>
</label>
...
<%
       ...
       ps = mk.con.prepareStatement("select distinct emp_desg from bgt_level where emp_code=? and bgt_yr=?");
       ps.setString(1,empcd);
       ...
       ps = mk.con.prepareStatement("select section_cd from bgt_cd_section where station_cd=?");
       ps.setString(1,stn_cd);
       rs = ps.executeQuery();
%>
<br>
...
%>
<tr>
<input type="hidden" id="seccd1" name ="seccd1" value="DGM1" />
                <td style="width: 20%" class="style5" align="center"><strong><input id="chk1" name="chk1" type="checkbox" /></strong></td>
                <td style="width: 30%" class="style5" align="center"><strong>DGM1</strong></td>
                <td style="width: 50%" class="style5" align="center"><strong><input type="text" id="rmks1" name="rmks1" value="" size="70"/></strong></td>
</tr>
<tr>
<input type="hidden" id="seccd2" name ="seccd2" value="DGM2" />
                <td style="width: 20%" class="style5" align="center"><strong><input id="chk2" name="chk2" type="checkbox" /></strong></td>
                <td style="width: 30%" class="style5" align="center"><strong>DGM2</strong></td>
                <td style="width: 50%" class="style5" align="center"><strong><input type="text" id="rmks2" name="rmks2" value="" size="70"/></strong></td>
</tr>
</table>
<%
}else{
