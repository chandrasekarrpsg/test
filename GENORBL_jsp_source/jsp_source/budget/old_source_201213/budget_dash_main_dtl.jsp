...
System.out.println("finyr2:"+finyr2);
       ...
       ps = mk.con.prepareStatement("select count(*) from bgt_level where emp_code=? and view_all_mkr='Y'");
       ps.setString(1,empcd);
       rs = ps.executeQuery();
       while(rs.next()){
...
<%
       ...
       ps2 = mk.con.prepareStatement("select count(*) from bgt_level where nvl(view_all_mkr,' ')='Y' and emp_code=? ");
       ps2.setString(1,empcd);
       rs2 = ps2.executeQuery();
       while(rs2.next()){
...
<%
       ...
       ps1 = mk.con.prepareStatement("select count(*) from bgt_level where emp_code=? and nvl(view_all_mkr,' ')='Y'");
...
if(auth_flg_view.equals("0")){
  if(rs.getString(1).equals("C")){
       ...
       ps1 = mk.con.prepareStatement("select count(*) from bgt_level where stn_cd=? and sec_cd<>'CTM' and emp_code=?");
       ps1.setString(1,rs.getString(1));
       ps1.setString(2,empcd);
       rs1 = ps1.executeQuery();
       while(rs1.next()){
