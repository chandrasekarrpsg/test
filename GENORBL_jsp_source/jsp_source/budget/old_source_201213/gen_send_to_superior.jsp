...
<%@ page language="java" import="java.sql.*,oracle.jdbc.driver.*,javax.servlet.jsp.tagext.*,javax.servlet.jsp.*,genOrblJavaPackage.*,javax.swing.*,java.io.PrintWriter; " %>
 ...
 <%
                        ...
                        try {
                             ...
                             cstmt = mk.con.prepareCall( "{call DPD_SEND_TO_SUPERIOR(?,?,?,?,?,?)}");
                             ...
                             System.out.println("DPD_SEND_TO_SUPERIOR PROCEDURE CALLED");
                             ...
                             if(iRet==1){
                                ...
                                if(iRet==0){
                                   ...
                                   iFailureFlag = 1;
                                   sMssg = "ERROR OCCURRED WHILE UPDATING BGT_LEVEL,SEND_TO_SUPERIOR_DT,SEND_TO_SUPERIOR_BY IN BGT_FORM2B_DATA,BGT_POSITION";
...
<%
                    ...
                    e.printStackTrace();
                    System.out.println("In EXCEPTION of gen_send_to_superior.jsp");
                    System.out.println("MESSAGE:"+sMssg);

                } finally {

                    System.out.println("In Finally of gen_send_to_superior.jsp");
                    try {
                        if (cstmt != null) {
                            cstmt.close();
                        }
