...
<form name = "BACK" method="POST" action="gen_div_compl_bgt_menu.jsp" target="_self">
 <input type="hidden"  name = "sec_cd"    value="" />
 <input type="hidden"  name = "stn_cd"    value="" />
...
<table style="width: 100%" class="style1">
	...
	<tr>
		...
		<td class="style4" colspan="17" align="center"><strong><span class="style5">COMPILED BUDGET</span> </strong></td>
	</tr>
	<tr>
