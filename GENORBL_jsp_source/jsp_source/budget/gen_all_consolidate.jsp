...
System.out.println("empcd:"+empcd);
                             ...
                             cstmt = mk.con.prepareCall( "{call DPD_GEN_ALL_CONSOLIDATE(?,?,?)}");
                             ...
                             System.out.println("DPD_GEN_ALL_CONSOLIDATE PROCEDURE CALLED");
                             ...
                             if(iRet==1){
                                ...
                                sMssg = "GEN CONSOLIDATION DONE SUCCESSFULLY ";
                             ...
                             cstmt = mk.con.prepareCall( "{call DPD_GEN_ALL_SPL_VIEW(?,?,?)}");
                             cstmt.setString(1,finyr);
                             cstmt.setString(2,empcd);
                             cstmt.registerOutParameter(3,OracleTypes.NUMBER);
                             cstmt.execute();
                             
                             System.out.println("DPD_GEN_ALL_SPL_VIEW PROCEDURE CALLED");
                             ...
                             if(iRet==1){
                                ...
                                sMssg = "DPD_GEN_ALL_SPL_VIEW PROCEDURE DONE SUCCESSFULLY. ";
...
%>
<label style="left:5px; top:100px; position:absolute;"><b>
<font face="Tahoma" color="red">CONSOLIDATION OF GENERATION BUDGET FOR FINANCIAL YEAR : <%=finyr1%> BY <%=cur_emp_desg%> FAILED!!!!!!! </font></b></label>
<br>
<br>
<label style="left:250px; top:150px; position:absolute;"><b>
<input type="button" name="back" id="back" value="BACK" onClick="back_prev();">
