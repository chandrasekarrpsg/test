...
<center>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="87%" height="30%" align="left" valign="top">
    <tr>
      <td width="100%" height="15%" align="left"><a href="generation_budget_compiled.jsp?stn_cd=A&sec_cd=ALL&bgt_hdr= &T1=<%=finyr%>&username=<%=empcd%>&emp_desg=<%=your_desg%>&bgt_ver=1" target="_self">
    ...
    <tr>
      <td width="100%" height="15%" align="left"><a href="generation_budget_finance.jsp?stn_cd=A&sec_cd=ALL&bgt_hdr= &T1=<%=finyr%>&username=<%=empcd%>&emp_desg=<%=your_desg%>&bgt_ver=1" target="_self">
    ...
    <tr>
      <td width="100%" height="15%" align="left"><a href="generation_budget_de_new.jsp?stn_cd=A&sec_cd=ALL&T1=<%=finyr%>&username=<%=empcd%>&emp_desg=<%=your_desg%>&bgt_lvl=2&stn_long_desc=GENERATION DIVISION " target="_self">
