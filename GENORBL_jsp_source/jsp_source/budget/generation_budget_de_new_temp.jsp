...
<%
  ...
  try{
     ...
     if(sBgt_Fr_Year.equals("new_year_entry")){
         ...
         ps1=mk.con.prepareStatement(" select distinct sec_cd from bgt_level where emp_code=? and stn_cd=? and bgt_yr=? and sec_cd<>'STN'  ");
     ...
     System.out.println("2222");
           ...
           ps1=mk.con.prepareStatement(" SELECT DISTINCT NVL(BGT_FNL,'N') BGT_FNL"+
                                       " FROM BGT_FORM2B_DATA_TEMP_CNSL "+
                                       " WHERE STN_CD = ? "+
                                       " AND   SEC_CD = ? "+
                                       " AND   BGT_YR = ? ");
...
<table style="width: 100%" class="style1">
	...
	<tr>
		...
		<td colspan="17" align="center" ><strong><span class="style7">SECTION(S) : <%= sSec_cd %></span></strong></td>
	</tr>
	<tr class="style23">
...
function openExcel(){
    ...
    if(flg==true){
      document.TO_EXCEL.action='generation_budget_de_new_temp_forexcel.jsp';
