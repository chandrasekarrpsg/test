...
<%
  ...
  try{
     ...
     System.out.println("generation_budget_de_new_temp_forexcel.jsp opened"+request.getRemoteAddr());
...
<%
     ...
     System.out.println("generation_budget_de_new_temp_forexcel.jsp closed"+request.getRemoteAddr());
