...
<iframe name="I5" id="I5" style="width: 0; height: 0" marginwidth="1" marginheight="1" scrolling="no" border="0" frameborder="0">
</iframe>
<%
  ...
  //       sBgt_Fr_Year = "2013";
         ...
         ps1=mk.con.prepareStatement(" SELECT STN_CD,"+
	                             ...
	                             "        EMP_DESG"+
	                             " FROM   BGT_LEVEL "+
                                     " WHERE  TRIM(EMP_CODE) = TRIM(?) AND BGT_YR = ? ") ;
         ps1.setString(1,sUsername);
         ps1.setString(2,sBgt_Fr_Year);
...
<script>
  ...
  document.NOTES.sec_cd.value= '<%= sSec_cd %>';
...
function openExcel(){
    ...
    if(flg==true){
      document.TO_EXCEL.action='generation_budget_de_bbgs_forexcel.jsp';
