...
function enableDisableButtons(disableMkrB1,disableMkrB2,disableMkrB3,disableMkrB5){
...
function summationAnnual(target_bgt_cell_Id,bgt_seq){
  ...
  if(parseFloat(summ_annual-0) == 0){
     ...
     summ_annual = summ_annual.toFixed(5);
...
//   alert(obj.id);
   ...
   var paddedValBefDec = lPad(valBefDec,7,' ');
   var paddedValAftDec = rPad(valAftDec,5,' ');
