...
<%@ page language="java" import="java.sql.*,oracle.jdbc.driver.*,javax.servlet.jsp.tagext.*,javax.servlet.jsp.*,genOrblJavaPackage.*,javax.swing.*,java.io.PrintWriter; " %>
 ...
 <%
                        ...
                        ResultSet rs = null;
                        System.out.println("gen_upd_aft_pub_bbgs.jsp. opened");
                        ...
                        System.out.println("sBgt_yr"+sBgt_yr+"sSec_cd"+sSec_cd+"sUsername"+sUsername+"sStn_cd"+sStn_cd+"sBgt_lvl"+sBgt_lvl);
                        ...
                        try {
                             ...
                             cstmt = mk.con.prepareCall( "{call DPD_UPD_AFT_PUBLISH_BBGS(?,?,?,?,?,?)}");
                             ...
                             System.out.println("DPD_UPD_AFT_PUBLISH_BBGS PROCEDURE CALLED");
                             ...
                             if(iRet==1){
                                ...
                                if(iRet==0){
                                   ...
                                   iFailureFlag = 1;
                                   sMssg = "ERROR OCCURRED WHILE UPDATING PUB_DT,PUB_MKR IN BGT_POSITION,BGT_FORM2B_DATA_BBGS";
...
<%
                    ...
                    e.printStackTrace();
                    System.out.println("In EXCEPTION of gen_upd_aft_pub_bbgs.jsp");
                    System.out.println("MESSAGE:"+sMssg);

                } finally {

                    System.out.println("In Finally of gen_upd_aft_pub_bbgs.jsp");
                    try {
                        if (cstmt != null) {
                            cstmt.close();
                        }
