...
<%@ page language="java" import="java.sql.*,oracle.jdbc.driver.*,javax.servlet.jsp.tagext.*,javax.servlet.jsp.*,genOrblJavaPackage.*,javax.swing.*,java.util.ArrayList,java.util.Iterator,java.io.PrintWriter; " %>
 ...
 <%
                        ...
                        ResultSet rs = null;
                        ArrayList aL1 = null;
                        System.out.println("gen_insert_upd_bbgs.jsp opened");
                        ...
                        try {
                                ...
                                if(sIns_Upd_Mkr.equals("I")){
                                   ...
                                   System.out.println("DPD_DEL_BGT_DATA_BBGS STARTED"+sBgt_yr+","+sStn_cd+","+sSec_cd);
                                   cstmt = mk.con.prepareCall( "{call DPD_DEL_BGT_DATA_BBGS(?,?,?,?)}");
                                   ...
                                   System.out.println("DPD_DEL_BGT_DATA_BBGS RETURNED VALUES"+iRet);

                                   cstmt.close();
                                   cstmt = null;
                                   System.out.println("DPD_DEL_BGT_DATA_BBGS cstmt closed");
                                   ...
                                   //       System.out.println("Each Elem["+(i)+"]["+(j)+"]:"+eachElem[i][j]);
                                             ...
                                             if(j>=0 && j<=3){
                                               sMnthString_1 = sMnthString_1+eachElem[i][j]+"|";
                                             }
                                             if(j>=4 && j<=7){
                                               sMnthString_2 = sMnthString_2+eachElem[i][j]+"|";
                                             }
                                             if(j>=8 && j<=11){
                                               sMnthString_3 = sMnthString_3+eachElem[i][j]+"|";
                                             }
                                             if(j>=12 && j<=15){
                                               sMnthString_4 = sMnthString_4+eachElem[i][j]+"|";
                                             }
                                             if(j>=16 && j<=19){
                                               sMnthString_5 = sMnthString_5+eachElem[i][j]+"|";
                                             }
                                             if(j>=20 && j<=23){
                                               sMnthString_6 = sMnthString_6+eachElem[i][j]+"|";
                                             }
                                             if(j>=24 && j<=27){
                                               sMnthString_7 = sMnthString_7+eachElem[i][j]+"|";
                                             }
                                             if(j>=28 && j<=31){
                                               sMnthString_8 = sMnthString_8+eachElem[i][j]+"|";
                                             }
                                             if(j>=32 && j<=35){
                                               sMnthString_9 = sMnthString_9+eachElem[i][j]+"|";
                                             }
                                             if(j>=36 && j<=39){
                                               sMnthString_10 = sMnthString_10+eachElem[i][j]+"|";
                                             }
                                             if(j>=40 && j<=43){
                                               sMnthString_11 = sMnthString_11+eachElem[i][j]+"|";
                                             }
                                             if(j>=44 && j<=47){
                                               sMnthString_12 = sMnthString_12+eachElem[i][j]+"|";
                                             }
                                             if(j>=48 && j<=51){
                                               sMnthString_13 = sMnthString_13+eachElem[i][j]+"|";
                                             }
   
                                          }

                                          sMnthString_1 = sMnthString_1 + "$$$";
                                          sMnthString_2 = sMnthString_2 + "$$$";
                                          sMnthString_3 = sMnthString_3 + "$$$";
                                          sMnthString_4 = sMnthString_4 + "$$$";
                                          sMnthString_5 = sMnthString_5 + "$$$";
                                          sMnthString_6 = sMnthString_6 + "$$$";
                                          sMnthString_7 = sMnthString_7 + "$$$";
                                          sMnthString_8 = sMnthString_8 + "$$$";
                                          sMnthString_9 = sMnthString_9 + "$$$";
                                          sMnthString_10 = sMnthString_10 + "$$$";
                                          sMnthString_11 = sMnthString_11 + "$$$";
                                          sMnthString_12 = sMnthString_12 + "$$$";
                                          sMnthString_13 = sMnthString_13 + "$$$";
                                          ...
                                          cstmt = mk.con.prepareCall( "{call DPD_INS_BGT_BBGS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"+
                                                                             "?,?,?,?,?,?,?,?,?)}");
                                          ...
                                          System.out.println("DPD_INS_BGT_BBGS PROCEDURE CALLED FOR BGT_SEQ"+sBgt_seq+"iteration:"+i);

                                          iRet = cstmt.getInt(23);
                                          System.out.println("PROCEDURE DPD_INS_BGT_BBGS RETURNED VALUES");
   
                                          cstmt.close();
                                          cstmt = null;
                                          System.out.println("DPD_INS_BGT_BBGS cstmt closed");
                                      ...
                                      if(iRet == 1){
                                          ...
                                          cstmt = mk.con.prepareCall( "{call DPD_COMPUTE_FOR_GEN_BGT_BBGS(?,?,?,?)}");
                                          ...
                                          cstmt.execute();
                                          iRet = cstmt.getInt(4);
                                          System.out.println("DPD_COMPUTE_FOR_GEN_BGT_BBGS RETURNED VALUES"+iRet);

                                          cstmt.close();
                                          cstmt = null;
                                          System.out.println("PROCEDURE DPD_COMPUTE_FOR_GEN_BGT_BBGS cstmt closed");

                                   }


                                   if(iRet==1){
                                      System.out.println("PROCEDURE DPD_INS_BGT_BBGS,DPD_COMPUTE_FOR_GEN_BGT_BBGS FOR INSERTION SUCCESS");
                                      ...
                                      cstmt.close();
                                      cstmt = null;
                                      System.out.println("PROCEDURE DPD_INS_BGT_POSITION cstmt closed");
                                   }else{
                                      System.out.println("PROCEDURE DPD_INS_BGT_POSITION INSERTION FAILED FOR BGT SEQ"+sBgt_seq);
                                   }

                                 }else{

                                      System.out.println("PROCEDURE DPD_DEL_BGT_DATA RECORDS NOT DELETED,RET VAL"+iRet_aft_del);
                                   ...
                                   for(int i = 0; i< i_Rows ; i++){
                                       ...
                                       if(iCol_indx>=4 && iCol_indx<=7){
                                              sMM_order = "1";
                                        }else{

                                              if(iCol_indx>=8 && iCol_indx<=11){
                                                 sMM_order = "2";
                                              }else{

                                                 if(iCol_indx>=12 && iCol_indx<=15){
                                                    sMM_order = "3";
                                                 }else{

                                                    if(iCol_indx>=16 && iCol_indx<=19){
                                                       sMM_order = "4";
                                                    }else{

                                                       if(iCol_indx>=20 && iCol_indx<=23){
                                                         sMM_order = "5";
                                                       }else{

                                                            if(iCol_indx>=24 && iCol_indx<=27){
                                                               sMM_order = "6";
                                                            }else{

                                                               if(iCol_indx>=28 && iCol_indx<=31){
                                                                   sMM_order = "7";
                                                                }else{

                                                                    if(iCol_indx>=32 && iCol_indx<=35){
                                                                       sMM_order = "8";
                                                                    }else{

                                                                         if(iCol_indx>=36 && iCol_indx<=39){
                                                                            sMM_order = "9";
                                                                         }else{

                                                                           if(iCol_indx>=40 && iCol_indx<=43){
                                                                              sMM_order = "10";
                                                                           }else{

                                                                                if(iCol_indx>=44 && iCol_indx<=47){
                                                                                   sMM_order = "11";
                                                                                }else{

                                                                                  if(iCol_indx>=48 && iCol_indx<=51){
                                                                                     sMM_order = "12";
                                                                                  }else{

                                                                                         if(iCol_indx>=52 && iCol_indx<=55){
                                                                                            sMM_order = "13";
                                                                                         }else{
                                           ...
                                           cstmt = mk.con.prepareCall( "{call DPD_UPD_BGT_BBGS(?,?,?,?,?,?,"+
                                                                           "?,?,?,?)}");
                                           ...
                                           cstmt.close();
                                           cstmt = null;
                                           System.out.println("DPD_UPD_BGT_BBGS cstmt.closed");

                                           System.out.println("PROCEDURE DPD_UPD_BGT_BBGS RETURNED VALUES="+iRet);
                                   ...
                                   if(iRet == 1){
                                          ...
                                          cstmt.close();
                                          cstmt = null;
                                          System.out.println("DPD_COMPUTE_FOR_GEN_BGT_BBGS cstmt.closed");

                                   }
                                   if(iRet==1){
                                      System.out.println("UPDATION OF BGT_FORM2B_DATA_BBGS,DPD_COMPUTE_FOR_GEN_BGT_BBGS SUCCEEDED");

                                   }else{

                                      System.out.println("UPDATION OF BGT_FORM2B_DATA_BBGS,DPD_COMPUTE_FOR_GEN_BGT_BBGS FAILED");
                                   }
...
<%
                    ...
                    e.printStackTrace();
                    System.out.println("In EXCEPTION of gen_insert_upd_bbgs.jsp");

                } finally {

                    System.out.println("In Finally of gen_insert_upd_bbgs.jsp");
                    try {
                        if (cstmt != null) {
                            cstmt.close();
                            System.out.println("In Finally callable statement closed");
                            cstmt=null;
                        }
                        if (mk != null) {
                            mk.con.close();
