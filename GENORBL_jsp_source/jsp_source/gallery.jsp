...
<li class="current"><a href="gallery.jsp"><span>Gallery</span></a></li>
...
<ul id="portfolio">					
					<li><div class="imgholder">
					  <img border="0" src="k1118050.jpg"  width="172" height="155"></div>
                      <div class="txtholder">
                      <p> 
				...
				<li>
				  <div class="imgholder">
                      <img border="0" src="k1451470.jpg"  width="172" height="155"></div>
                      <div class="txtholder">
                      <p> 
