...
try{
 ...
 qry =   "  select						  " +
         ...
         "  TO_CHAR(NVL(p1_labour_total, 0),'99999999999990.09'), " +
         "  TO_CHAR(NVL(p1_material_total, 0),'999999999990.09'), " +
         "  TO_CHAR(NVL(p1_q1_total, 0), '999999999999990.09'),	  " +
         "  NVL(p1_q2_no, '$'),				          " +
         "  NVL(to_char(p1_q2_date, 'dd-MON-yyyy'), '$'),	  " +
         "  TO_CHAR(NVL(p1_q2_total, 0), '999999999999990.09'),	  " +
         "  NVL(p1_q3_no, '$'),				          " +
         "  NVL(to_char(p1_q3_date, 'dd-MON-yyyy'), '$'),	  " +
         "  TO_CHAR(NVL(p1_q3_total, 0), '999999999999990.09'),	  " +
         "  NVL(erp_code, ' '),				          " +
         "  order_type,					          " +
         "  budget_head,					  " +
         "  NVL(capex_scheme_no, ' '),			          " +
         "  job_desc,						  " +
         "  TO_CHAR(p1_total, '999999999999990.09') order_value,  " +
         "  esi_clause,					          " +
         "  job_place,					          " +
         "  safety_related,					  " +
         "  environment_Clause,				          " +
         ...
         job_place	       = rs.getString(39);
         safety_related	       = rs.getString(30);
         environment_clause    = rs.getString(31);
         retention_prcnt       = rs.getString(32);
         job_complete	       = rs.getString(33);
         station	       = rs.getString(34);
         signatory             = rs.getString(35);
         signatory_loc         = rs.getString(36);
         l1_signatory          = rs.getString(37);
         l2_signatory          = rs.getString(38);
         l3_signatory          = rs.getString(39);
         amt_in_words          = rs.getString(40);
...
// window.parent.I1.focus();
 document.all.printReady.style.zoom='70%';
 window.print();
}
...
<body onload ="javascript:mmprint();"> 
...
<% }else if(copy.equals("VENDOR") && lthd.equals("yes")){ %>
 <div align="center" id="printReady" class="c1" style="width: 967px; height: 1270px;">
<table border="0" cellpadding="0" cellspacing="0" width="80%" style="border-collapse: collapse" bordercolor="#111111">
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp; </td>
  </tr>
...
<% } %>
  ...
  <tr>
    <td colspan="2"><textarea rows="5" id="cont_ad" name="cont_ad" cols="100" style="overflow: hidden; font-family: Verdana; font-size: 12; border: medium none">
<%=address1%>
<%=address2%>
<%=address3%>
<%=address4%>
...
<% if(clubbed.equals("Y")){ %>
   ...
   <% if(!p1_q2_no.equals("$") && !p1_q2_date.equals("$")) { %>
       ...
       <strong><%=p1_q2_no%>
       <strong>&nbsp;&nbsp;&nbsp;&nbsp;Dated:</strong>&nbsp;<%=p1_q2_date%>;
       </font>
   <% } %>
   <% if(!p1_q3_no.equals("$") && !p1_q3_date.equals("$")) { %>
       <font face="Verdana" style = "font-size:14px;">
       <strong>Your Quotation Number :</strong>&nbsp;<%=p1_q3_no%>
       <strong>&nbsp;&nbsp;&nbsp;&nbsp;Dated:</strong>&nbsp;<%=p1_q3_date%>;
       </font>
   <% } %>
       </td>
       </tr>
...
<% /*************************************************************************************************/  %>
  ...
  <tr>
    ...
    <font face="Verdana" style = "font-size:14px;" align="justify" valign="top"><strong><%=job_desc%></strong></font>
    </td></tr>
    </table>
  </td>
  </tr>
...
<% /* '*********************** Opening Lines ***********************************/ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">
    We thank you for your above Quotation and are pleased to place this Order on you for the above mentioned job at an amount of Rs. <%=order_value%> (Rupees <%=amt_in_words%>) based on your quoted rate.</font></td>
  </tr>

<% /************************** MOTHER CLAUSE   ************************************************/ %>

<%if(job_complete.equals("N") && ( esi_clause.equals("Y") ||  environment_clause.equals("Y") )){ %>
  <tr>
    <td align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
  </tr>
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">This order is being placed on you subject to your observance of all statutory obligations and security instructions as applicable for working at our Generating Stations. 
    Also note the following terms and conditions:</font></td>
  </tr>
...
<%if(esi_clause.equals("Y")){%>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">You will be responsible for all statutory obligations under the Contract Labour (Regulation and Abolition) Act 1970, ESI Act 1948 and Employees Provident Fund and Miscellaneous Provisions Act 1952.
    </font></td>
  </tr>
<% } %>
...
<%if(job_place.equals("I")){%>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">In particular you shall keep us indemnified against all claims and disputes arising out of accidents/damages to your workmen & staff, third parties and properties belonging to us. Necessary Workmen's Compensation Insurance shall be taken out by you accordingly.</font></td>
  </tr>
...
<% if(safety_related.equals("Y")){ %>
  ...
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp; </td>
      ...
      <tr>
        <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">Site cleaning must be done by you upto the satisfaction of the controlling officer after completion of the job. All scrap materials should be removed to the place specified by the controlling officer. A maximum penalty amounting to 5% of the order value will be applicable if scrap materials are not removed within 48 Hrs of completion of the job.</font></td>
      </tr>
    <% } %>
  ...
  <tr>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp; </td>
      ...
      <tr>
        <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">Site cleaning must be done by you upto the satisfaction of the controlling officer after completion of the job. All scrap materials should be removed to the place specified by the controlling officer. A penalty upto 5% of the order value will be applicable if scrap materials are not removed to the designated areas within 48 Hrs of completion of the job.</font></td>
      </tr>
    <% } %>
...
<%if( esi_clause.equals("Y") ||  job_place.equals("Y") ||  safety_related.equals("Y") ||  environment_clause.equals("Y")){ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">In addition to the terms and conditions specified above you will be required to ensure that all statutory payments as now is in force or may be applicable from time to time are made to your workmen.</font></td>
  </tr>
<% } %>
...
<% if(!retention_prcnt.equals("0")){ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;"><%=retention_prcnt%>% of the Labour component of billed value will be withheld as retention and released only after ascertaining that all terminal payments, as applicable, have been made by you.</font></td>
  </tr>
<% } %>
...
<% if(job_complete.equals("N")){ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">After successful completion of the aforementioned job you may please send the bill to us for payment including Service tax and Works Contract Tax as applicable.</font></td>
  </tr>
...
<% if(job_complete.equals("Y")){ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">Since you have already carried out the work as instructed by the Station Engineers, you may please send the bill to us for payment including Service Tax and Works Contract Tax as applicable.</font></td>
  </tr>
...
<% if(!retention_prcnt.equals("0") && job_complete.equals("Y")){ %>
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;"><%=retention_prcnt%>% of the Labour component of billed value will be with
held as retention and released only after ascertaining that all terminal payments, as applicable, have been made by you.</font></td>
  </tr>
<% } %>
...
<% if(!p1_material_total.trim().equals("0.00")){ %>
  <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="80%" style="border-collapse: collapse" bordercolor="#111111">
  ...
  <tr>
    <td colspan="2" align="justify"><font face="Verdana" style = "font-size:14px;">cc: The Dy. General Manager (Finance): For necessary actions as warranted in terms and conditions of this order.</font></td>
  </tr>
</table>
<% } %>
...
<%
  ...
  qry =  "  select                                                " +
         ...
         "  TO_CHAR(NVL(p2_q1_total, 0), '999999999999990.09'),   " +
         "  NVL(p2_q2_no, '$'),                                   " +
         "  NVL(to_char(p2_q2_date, 'dd-MON-yyyy'), '$'),         " +
         "  TO_CHAR(NVL(p2_q2_total, 0), '999999999999990.09'),   " +
         "  NVL(p2_q3_no, '$'),                                   " +
         "  NVL(to_char(p2_q3_date, 'dd-MON-yyyy'), '$'),         " +
         "  TO_CHAR(NVL(p2_q3_total, 0), '999999999999990.09'),   " +
         ...
         "  TO_CHAR(NVL(p3_q1_total, 0), '999999999999990.09'),   " +
         "  NVL(p3_q2_no, '$'),                                   " +
         "  NVL(to_char(p3_q2_date, 'dd-MON-yyyy'), '$'),         " +
         "  TO_CHAR(NVL(p3_q2_total, 0), '999999999999990.09'),   " +
         "  NVL(p3_q3_no, '$'),                                   " +
         "  NVL(to_char(p3_q3_date, 'dd-MON-yyyy'), '$'),         " +
         "  TO_CHAR(NVL(p3_q3_total, 0), '999999999999990.09'),   " +
         ...
         "  to_char(NVL(p2_q1_total, 0)+NVL(p2_q2_total, 0)+NVL(p2_q3_total, 0), '99999999999990.09') p2_total,  " +
         "  to_char(NVL(p3_q1_total, 0)+NVL(p3_q2_total, 0)+NVL(p3_q3_total, 0), '99999999999990.09') p3_total   " +
         "  from ORBL_ORD_DTL o,                                  " +
