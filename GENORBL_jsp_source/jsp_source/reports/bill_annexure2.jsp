...
System.out.println("bill_annexure2 gen_stn :"+gen_stn);
System.out.println("bill_annexure2 fin_yr :"+fin_yr);
System.out.println("bill_annexure2 year1 :"+year1);
...
<%
    ...
    System.out.println("BILL_ANNEXURE2 GS: " + GStn);
...
<form method="POST" name="sampleform" action="bill_annexure2.jsp" 
...
%>
    ...
    <table  border="1" width="97%" class= "rcrds">
     ...
     <tr bgcolor="#DBF2DC">
          ...
          <td align="center" width="90px"   class= "rcrdsEle" ><font color="#400040" size="2"><b>Order Amt(Rs)</b></font></td>
          <td align="center" width="260px"  class= "rcrdsEle" ><font color="#400040" size="2"><b>Scope</b></font></td>
...
<%
        ...
        System.out.println("BILL_ANNEXURE2 H_TYP: " +h_typ);
        System.out.println("BILL_ANNEXURE2 St DT : " +st_dt);
        System.out.println("BILL_ANNEXURE2 End DT : " +end_dt);
        ...
        qry_str1 ="SELECT DISTINCT nvl(b.remarks,' '),                                                                " +
	          ...
	          "       decode(o.P1_TOTAL,0,' ',to_char(o.P1_TOTAL,'999,99,99,990.99')) ord_amt,                    " +
                  "       o.JOB_DESC ntre_of_wrk,                                                                     " + 
	          "       trim(o.ERP_CODE)  acno,                                                                     " +
                  "       o.ORDER_ID                                                                                  " +
                  "FROM   orbl_bill_dtl     b,                                                                        " +
                  "       orbl_ord_dtl      o,                                                                        " +
	          "       orbl_vendor_mst   v                                                                         " +
                  "WHERE  o.ORDER_DATE between TO_DATE(?,'DD-MON-RR') and TO_DATE(?,'DD-MON-RR')                      " +
      ...
      System.out.println("BILL_ANNEXURE2 qry_str1: " +qry_str1);

      qry_str2 = "SELECT decode(sum(o.P1_TOTAL),0,' ',to_char(sum(o.P1_TOTAL),'999,99,99,990.99')) tot_amt           " +
                 "FROM   orbl_bill_dtl     b,                                                                        " +
                 "       orbl_ord_dtl      o,                                                                        " + 
	         "       orbl_vendor_mst   v                                                                         " + 
                 "WHERE  o.ORDER_DATE between TO_DATE(?,'DD-MON-RR') and TO_DATE(?,'DD-MON-RR')                      " +
...
<%
              ...
              ord_dt   = rs1.getString(4);
              ord_amt  = rs1.getString(5);
              scope    = rs1.getString(6);
...
%>
    <tr bgcolor="#DBF2DC">
          ...
          <td align="left"   width="260px"  class= "rcrdsEle" ><font color="#800040" size="2"><%=scope%></font></td>
