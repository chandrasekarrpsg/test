...
<form method="POST" name="sampleform" id="f1" action="bill_not_rcvd.jsp" valign="middle" align="center" >
...
<TABLE>
<TR>
<TD align="center"><input type = "button" value="SUBMIT" onClick="DfltVal_Bl_Nt_Rcvd();"></TD>
<TD>&nbsp;&nbsp;</TD>
...
<form method="POST" name="frm" id="f2"  action="bill_not_rcvd_xls.jsp" valign="middle" align="center" >
