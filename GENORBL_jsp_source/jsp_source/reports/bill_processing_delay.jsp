...
<input id="img1" type="image" alt="EXPORT TO EXCEL" src="excel_img.jpg"
 onClick="window.open('bill_processing_delay_xls.jsp?gstn=<%=genstn%>&dept=<%=dept1%>&frm_dt=<%=st_dt1%>&to_dt=<%=end_dt1%>');" >
...
<td align=center> <font color="#400040" size="3"><b>DELAY (DAYS) IN RELEASING OF BILLS</b></font></td>
