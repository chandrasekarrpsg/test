...
<%!    BudgetProcessBeanRemote hRemote = null;
    ...
    public void jspInit() {
        try {
            ...
            System.out.println("budgRepDtls1.jsp can't be initialsed for " + e.getMessage());
        }
    }
%>
...
<html>
    ...
    <body>
        <%
                    response.setHeader("Content-Disposition", "inline; filename=" + "budgReptDtls1.xls");
                    ...
                    lstDtls = hRemote.getStnActDtls_1(sMtdYtd, sFinYr, sMon, sMontr, sStn, sGrp);
