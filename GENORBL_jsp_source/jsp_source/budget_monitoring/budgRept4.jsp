...
<html>
    ...
    <body onload="if(i == 1){animatedcollapse.hide('div_img')}">
        <center>
            ...
            <br>
            <form name="form_1" action = "budgRept4.jsp" method="post" target="_self">
                <div style="background-color : #deffdd">
                    <table>
                        <tr>
                            <td width="25%" align="left">Station-&gt;Group-&gt;Dept
                            </td>
            ...
            <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  1start-->
                ...
                <tbody><!--  1start-->
                    ...
                    <%
                                                ...
                                                List lstPerStnPerGrpAllDeptSumm_4 = null;
                                                List lstPerStnPerGrpPerDeptAllMnthSumm_4 = null;
                                                //List rows = null;
                                                //Iterator iterateOuter = null;
                                                //Iterator iterateInner = null;
                                ...
                                <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  2start-->
                                    ...
                                    <tbody><!--  2start-->
                                        ...
                                        <tr bgcolor = "#99ccff">
                                            <%                                                                                                                       }
                                            %>
                                            <td><img name="img<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%>" src="Pics/Order/plus_1.png" style="width : 20px ; height : 20px ; cursor : pointer" onclick = "clickImg(this);"/></td>
                                            <td><%= sGrp%></td>
                                            <td><%= sMTDBudg%></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%>' style="display : none"><!--  2start-->
                                                    <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  3start-->
                                                        ...
                                                        <tbody><!--  3start-->
                                                            <%
                                                                                                                                                                    lstPerStnPerGrpAllDeptSumm_4 = hRemote.getPerStnPerGrpAllDeptSumm_4(sFinYr, sMon, sMontr, sStn, sGrp.substring(0, 1));
                                                                                                                                                                    iterateOuter_3 = lstPerStnPerGrpAllDeptSumm_4.iterator();
                                                                                                                                                                    int k = 0;
                                                                                                                                                                    while (iterateOuter_3.hasNext()) {
                                                                                                                                                                        rows = (List) iterateOuter_3.next();
                                                                                                                                                                        iterateInner_3 = rows.iterator();
                                                                                                                                                                        while (iterateInner_3.hasNext()) {
                                                                                                                                                                            sDept = (String) iterateInner_3.next();
                                                            ...
                                                            <tr bgcolor="#e6e2da">
                                                                <%                                                                                                                                                                                                             }
                                                                %>
                                                                <td><img name="img<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>" src="Pics/Order/plus_1.png" style="width : 20px ; height : 20px ; cursor : pointer" onclick = "clickImg(this);"/></td>
                                                                <td><%= sDept%></td>
                                                                <td><%= sMTDBudg%></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="9">
                                                                    ...
                                                                    <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>' style="display : none"><!--  3start-->
                                                                        <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="580"><!--  4start-->
                                                                            ...
                                                                            <tbody><!--  4start-->
                                                                                <%
                                                                                                                                                                                                                                lstPerStnPerGrpPerDeptAllMnthSumm_4 = hRemote.getPerStnPerGrpPerDeptAllMnthSumm_4(sFinYr, sMontr, sStn, sGrp.substring(0, 1), sDept);

                                                                                                                                                                                                                                iterateOuter_4 = lstPerStnPerGrpPerDeptAllMnthSumm_4.iterator();
                                                                                                                                                                                                                                int l = 0;
                                                            ...
                                                            animatedcollapse.addDiv('div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>', 'optional_attribute_string')
                                                        </script>
                                                        <%
                                                                                                                                                                } //end while 3 %>
                                                        </tbody><!--  4end-->
                                    ...
                                    <script>
                                        animatedcollapse.addDiv('div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 2)%>', 'optional_attribute_string')
                                    </script>
                                    <%
                                                                                        }
                                    %>
        ...
        <form name="form_2" action="budgReptDtls4.jsp" method="post" target="_blank">
