...
<%!    BudgetProcessBeanRemote hRemote = null;
    ...
    public void jspInit() {
        try {
            ...
            System.out.println("budgRepDtls5.jsp can't be initialsed for " + e.getMessage());
        }
    }
%>
...
<html>
    ...
    <body>
        <%
                    response.setHeader("Content-Disposition", "inline; filename=" + "budgReptDtls5.xls");
                    ...
                    String sBudgGrp = request.getParameter("sBudgGrp");
                    ...
                    //System.out.println("2222 : " + sStn);
                    //System.out.println("2222 : " + sGrp);
                    //System.out.println("2222 : " + sBudgGrp);
                    //System.out.println("2222 : " + sBudgHd);


                    lstDtls = hRemote.getStnActDtls_5(sMtdYtd, sFinYr, sMon, sMontr, sStn, sGrp, sBudgGrp, sBudgHd);
        ...
        <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880" style="border-collapse : collapse"><!--  1start-->
            ...
            <tbody>
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td valign="top" class="style34"><font size="1"><%= sErpCd%></font></td>
