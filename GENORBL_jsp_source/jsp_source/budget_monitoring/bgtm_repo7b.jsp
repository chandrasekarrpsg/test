...
function popl_dt_fin_finyr_M() {
var xmldiffrnciator = Math.floor(Math.random() * 100000);
var params = "stn_cd="+document.f1.station.value+"&finyr="+document.f1.finyr.value;
params += "&xmldiffrnciator="+xmldiffrnciator;
var url = "popl_dt_fin_finyr_M.jsp";
http1.open("POST", url, true);
http1.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
http1.onreadystatechange = function()
   {
        ...
        {
              var results = http1.responseText.split("@");
              document.f1.fin_frmdt_M.value=results[0];
              document.f1.fin_endt_M.value=results[1];
...
if(!check_date_less_st(document.f1.fin_frmdt_M,document.f1.frmdt_M)){
  alert('Start Date should be '+document.f1.fin_frmdt_M.value+' For Finnancial Year '+document.f1.finyr.value);
  return false;
}else if(!check_date_less(document.f1.fin_endt,document.f1.todt_M)){
  alert('END Date should be '+document.f1.fin_endt.value+' For Finnancial Year '+document.f1.finyr.value);
  return false;
}else if(!check_date_less_st(document.f1.fin_frmdt,document.f1.frmdt_C)){
  alert('Start Date should be '+document.f1.fin_frmdt.value+' For Finnancial Year '+document.f1.finyr.value);
  return false;
}else if(!check_date_less(document.f1.fin_endt,document.f1.todt_C)){
  alert('END Date should be '+document.f1.fin_endt.value+' For Finnancial Year '+document.f1.finyr.value);
  return false;
}else{
  var parameter='';
   parameter = parameter + 'empcd='+document.f1.empcd.value;
   parameter = parameter + '&frmdt_M='+document.f1.frmdt_M.value;
   parameter = parameter + '&todt_M='+document.f1.todt_M.value;
   parameter = parameter + '&frmdt_C='+document.f1.frmdt_C.value;
   parameter = parameter + '&todt_C='+document.f1.todt_C.value;
...
//alert(parameter);
window.open("bgtm_repo7b.jsp?"+parameter,"_self");
}
}
...
int iSl_No = 0;
  ...
  String cur_month_C                = new String("");
  String cur_month_M                = new String("");
  String cur_yr                     = new String("");
  String frm_month_C                = new String("");
  String frm_month_M                = new String("");
  String frm_month                  = new String("");
  String frm_yr                     = new String("");
  String frmdt_M                    = new String("");
  String todt_M                     = new String("");
  String frmdt_C                    = new String("");
  String todt_C                     = new String("");
  ...
  String act_frm_dt_M               = new String("");
  String act_frm_dt_C               = new String("");
...
try{
     ...
     frmdt_M   = request.getParameter("frmdt_M");
     todt_M    = request.getParameter("todt_M");
     frmdt_C   = request.getParameter("frmdt_C");
     todt_C    = request.getParameter("todt_C");	 
...
System.out.println("frmdt_M:"+frmdt_M);
System.out.println("todt_M:"+todt_M);
System.out.println("frmdt_C:"+frmdt_C);
System.out.println("todt_C:"+todt_C);
...
<form method="post" name="f1" action="bgtm_repo7b.jsp">
...
%>
        ...
        <tr height="10">
           <td style="width: 20%" align="left"><strong><font face="Book Antiqua" color="#800000" size="3">(MATERIALS)From Date :&nbsp;&nbsp;&nbsp;
              <INPUT name=frmdt_M style="HEIGHT: 22px; WIDTH: 95px" size="12" value="<%=frmdt_M%>" onblur="" readOnly onclick="scwShow(this,event);">
           </strong></td>
           <td style="width: 20%" align="left"><strong><font face="Book Antiqua" color="#800000" size="3">(MATERIALS)To Date :&nbsp;&nbsp;&nbsp;
              <INPUT name=todt_M style="HEIGHT: 22px; WIDTH: 95px" size="12" value="<%=todt_M%>" onblur="" readOnly onclick="scwShow(this,event);">
           </strong></td>
           <td style="width: 20%" align="left"><strong><font face="Book Antiqua" color="#800000" size="3">(COTRACT)From Date :&nbsp;&nbsp;&nbsp;
              <INPUT name=frmdt_C style="HEIGHT: 22px; WIDTH: 95px" size="12" value="<%=frmdt_C%>" onblur="" readOnly onclick="scwShow(this,event);">
           </strong></td>
           <td style="width: 20%" align="left"><strong><font face="Book Antiqua" color="#800000" size="3">(COTRACT)To Date :&nbsp;&nbsp;&nbsp;
              <INPUT name=todt_C style="HEIGHT: 22px; WIDTH: 95px" size="12" value="<%=todt_C%>" onblur="" readOnly onclick="scwShow(this,event);">
           </strong></td>		   
        </tr>
        <tr height="10">
...
cur_month_M    = todt_M.substring(3,6);
frm_month_M    = frmdt_M.substring(3,6);
cur_month_C    = todt_C.substring(3,6);
frm_month_C    = frmdt_C.substring(3,6);
cur_month      = todt_C.substring(3,6);
frm_month      = frmdt_C.substring(3,6);

if(cur_month_C.equals("Apr")){
       ...
       ps.setString(3,todt_C);
       ps.setString(4,todt_C);
...
if(cur_month_M.equals("Apr")){
	   
	   ps = mk.con.prepareStatement(" select count(*) from FINNANCE_FINYR_FOR_M where FINANCE_FINYR = " + 
                                    " and STN = decode(?,'BBGS','B','SGS','S','TGS','T','NCGS','N','CTM','C','EDGE','E','B') "+
                                    " and end_date >= to_date(?,'dd/mm/rr') and substr(?,8,4) <> substr(?,1,4) ");
       ps.setString(1,finyr);
       ps.setString(2,station);
       ps.setString(3,todt_M);
       ps.setString(4,todt_M);
       ps.setString(5,finyr);
       rs = ps.executeQuery();
       while(rs.next()){
            chk_to_dt = rs.getString(1);
...
if(chk_to_dt.equals("1")){
   cur_month_M ="Mar";       
       ...
       rs = ps.executeQuery();
       while(rs.next()){
            act_frm_dt_C = rs.getString(1);
       }
       rs.close();
       ps.close();

	   ps = mk.con.prepareStatement(" select to_char(start_date,'dd/mm/rr') " + 
                                    " from FINNANCE_FINYR_FOR_M where FINANCE_FINYR=? "+ 
                                    " and STN=decode(?,'BBGS','B','SGS','S','TGS','T','NCGS','N','CTM','C','EDGE','E','B')  ");
       ps.setString(1,finyr);
       ps.setString(2,station);
       rs = ps.executeQuery();
       while(rs.next()){
            act_frm_dt_M = rs.getString(1);
       }
       rs.close();
       ps.close();
...
<input type="hidden" id= "act_frm_dt_M" name = "act_frm_dt_M" value="<%=act_frm_dt_M%>" />
<input type="hidden" id= "act_frm_dt_C" name = "act_frm_dt_C" value="<%=act_frm_dt_C%>" />
<input type="hidden" id= "fin_frmdt"    name = "fin_frmdt" value="" />
<input type="hidden" id= "fin_endt"     name = "fin_endt" value="" />
<input type="hidden" id= "fin_frmdt_M"    name = "fin_frmdt_M" value="" />
<input type="hidden" id= "fin_endt_M"     name = "fin_endt_M" value="" />
...
<table style="width: 100%" border="1">
        ...
        <tr>
                <td style="width: 20%" class="style8"  colspan="12" align="middle">
                    <strong>Cash Flow Monitoring Statement (in Rs. Lacs)</strong>
                    Dates Considered For Materials <%=frmdt_M%> To <%=todt_M%> And For Contracts <%=frmdt_C%> To <%=todt_C%>
         </td>
        </tr>
        <tr>
...
ps1.close();
       ...
       ps1 = mk.con.prepareStatement(" select  to_char(nvl(sum(amt),0),'9999999990.999') from ("+
                                     " select /*+ rule */  to_char(nvl(sum(amt),0),'9999999990.999') amt "+
                                     ...
                                     " union  "+
                                     " select /*+ rule */  to_char(nvl(sum(amt),0),'9999999990.999') "+
                                     " from BGTM_REPO_STRUC_SPL "+
                                     " where BGT_FROM = ? "+ 
                                     " and   bgt_mkr='B' "+
                                     " and   target_floor ='T' "+
                                     " and   STN_CD like decode(?,'BBGS','B','TGS','T','SGS','S','NCGS','N','CTM','C','EDGE','E','ALL','%') "+ 
                                     " and   SEC_CD like decode(?,'ALL','%',?) "+
                                     " and   BGT_HD NOT IN ('2a-2','2b','2c','3a','3b','3c','4a','4b','4c','4d') "+
                                     " and   BGT_HD =  ? "+
                                     " and   MM_VAL=to_char(to_date(?,'Mon'),'MM') "+
                                     " and   stn_extn is null )"
                                     );
       ...
       ps1.setString(6,cur_month_M);

       ps1.setString(7,finyr1);
       ps1.setString(8,station);
       ps1.setString(9,section);
       ps1.setString(10,section);
       ps1.setString(11,rs.getString(2));
       ps1.setString(12,cur_month_C);
...
ps1.close();
       ...
       ps1 = mk.con.prepareStatement(" select /*+ rule */ to_char(nvl(sum(trans_amt),0),'9999999990.999') from ("+
	                             " select  stn_cd,dept,sum(trans_amt) trans_amt "+
				     ...
				     " and   trns_date between to_date('01-'||?||'-'||?,'DD-Mon-yyyy') and to_date(?,'DD-Mon-yyyy') "+
                                     " and   send_recv_mkr=  ? "+
				     " group by stn_cd,dept )  "+
				     " order by decode(stn_cd,'B','1','T','2','S','3','N','4','C','5','E','6'),dept");
       ...
       ps1.setString(8,cur_month_C);
       ps1.setString(9,finyr1);
       ps1.setString(10,todt_C);
       ps1.setString(11,mon_basis);
	   
       ps1.setString(12,finyr1);
       ps1.setString(13,station);
       ps1.setString(14,station);
       ps1.setString(15,section);
       ps1.setString(16,section);
       ps1.setString(17,rs.getString(2));
       ps1.setString(18,rs.getString(2));
       ps1.setString(19,cur_month_M);
       ps1.setString(20,finyr1);
       ps1.setString(21,todt_M);
       ps1.setString(22,mon_basis);
...
ps1.close();
       ...
       ps1 = mk.con.prepareStatement( " select to_char(nvl(sum(amt),0),'9999999990.999')  from ( "+
                                     " select /*+ rule */  to_char(nvl(sum(amt),0),'9999999990.999') amt from BGTM_REPO_STRUC_SPL "+ 
                                     " where BGT_FROM = ? "+ 
                                     " and   bgt_mkr='B' "+ 
                                     " and   target_floor ='T' "+
                                     " and   STN_CD like decode(?,'BBGS','B','TGS','T','SGS','S','NCGS','N','CTM','C','EDGE','E','ALL','%') "+ 
                                     ...
                                     " and   stn_extn is null "+
                                     " union "+
                                     " select /*+ rule */  to_char(nvl(sum(amt),0),'9999999990.999')  from BGTM_REPO_STRUC_SPL "+
                                     " where BGT_FROM = ? "+ 
                                     " and   bgt_mkr='B' "+ 
                                     " and   target_floor ='T' "+
                                     " and   STN_CD like decode(?,'BBGS','B','TGS','T','SGS','S','NCGS','N','CTM','C','EDGE','E','ALL','%') "+ 
       ...
       ps1.setString(4,section);
       ps1.setString(5,rs.getString(2));
       ps1.setString(6,frm_month_M);
       ps1.setString(7,frm_yr);
       ps1.setString(8,cur_month_M);
       ps1.setString(9,cur_yr);
 
       ps1.setString(10,finyr1);
       ps1.setString(11,station);
       ps1.setString(12,section);
       ps1.setString(13,section);
       ps1.setString(14,rs.getString(2));
       ps1.setString(15,frm_month_C);
       ps1.setString(16,frm_yr);
       ps1.setString(17,cur_month_C);
       ps1.setString(18,cur_yr);
...
System.out.println("cur_yr:"+cur_yr);
       ...
       ps1.setString(6,rs.getString(2));
       ps1.setString(7,rs.getString(2));
       ps1.setString(8,frmdt_C);
       ps1.setString(9,todt_C);
       ps1.setString(10,mon_basis);
       ps1.setString(11,finyr1);
       ps1.setString(12,station);
       ps1.setString(13,station);
       ps1.setString(14,section);
       ps1.setString(15,section);
       ps1.setString(16,rs.getString(2));
       ps1.setString(17,rs.getString(2));
       ps1.setString(18,frmdt_M);
       ps1.setString(19,todt_M);
       ps1.setString(20,mon_basis);
...
%>
                <td style="width: 10%" class="<%=sStyle2%>"><strong><a href="#" onClick="window.open('view_act_exp_dtl_7b.jsp?finyr1=<%=finyr1%>&cur_month=<%=cur_month%>&cur_yr=<%=cur_yr%>&frm_month=<%=frm_month%>&frm_yr=<%=frm_yr%>&station=<%=station%>&dept=<%=section%>&finyr=<%=finyr%>&bgt_hd=<%=rs.getString(2)%>&empcd=<%=empcd%>&view_mkr=M&mon_basis=<%=mon_basis%>&frmdt_M=<%=frmdt_M%>&todt_M=<%=todt_M%>&frmdt_C=<%=frmdt_C%>&todt_C=<%=todt_C%>','_new');"><%=mtd_exp_act%></strong></td>
<%
}else{
%>
...
%>
                <td style="width: 10%" class="<%=sStyle2%>"><strong><a href="#" onClick="window.open('view_act_exp_dtl_7b.jsp?finyr1=<%=finyr1%>&cur_month=<%=cur_month%>&cur_yr=<%=cur_yr%>&frm_month=<%=frm_month%>&frm_yr=<%=frm_yr%>&station=<%=station%>&dept=<%=section%>&finyr=<%=finyr%>&bgt_hd=<%=rs.getString(2)%>&empcd=<%=empcd%>&view_mkr=Y&mon_basis=<%=mon_basis%>&frmdt_M=<%=frmdt_M%>&todt_M=<%=todt_M%>&frmdt_C=<%=frmdt_C%>&todt_C=<%=todt_C%>','_new');"><%=ytd_exp_act%></strong></td>
<%
}else{
%>
...
if(group.equals("ALL")){
       ...
       ps1 = mk.con.prepareStatement(" select to_char(nvl(sum(amt),0),'9999999990.999') amt from ("+
                                     " select /*+ rule */ to_char(nvl(sum(amt),0),'9999999990.999') amt "+
                                     " from BGTM_REPO_STRUC_SPL "+
                                     " where BGT_FROM = ? "+ 
                                     " and   bgt_mkr='B' "+
       ...
       ps1.setString(3,section);
       ps1.setString(4,section);
       ps1.setString(5,cur_month_M);
       ps1.setString(6,finyr1);
       ps1.setString(7,station);
       ps1.setString(8,section);
       ps1.setString(9,section);
       ps1.setString(10,cur_month_C);
...
ps1.close();
      ...
      ps1 = mk.con.prepareStatement( " select /*+ rule */  to_char(nvl(sum(trans_amt),0),'9999999990.999') from ("+
       ...
       ps1.setString(4,section);
       ps1.setString(5,section);
       ps1.setString(6,cur_month_C);
       ps1.setString(7,finyr1);
       ps1.setString(8,todt_C);
       ...
       ps1.setString(13,section);
       ps1.setString(14,section);
       ps1.setString(15,cur_month_M);
       ps1.setString(16,finyr1);
       ps1.setString(17,todt_M);
       ps1.setString(18,mon_basis);
       rs1 = ps1.executeQuery();
while(rs1.next()){
...
ps1.close();
       ...
       ps1.setString(3,section);
       ps1.setString(4,section);
       ps1.setString(5,frm_month_M);
       ps1.setString(6,frm_yr);
       ps1.setString(7,cur_month_M);
       ps1.setString(8,cur_yr);
       ps1.setString(9,finyr1);
       ps1.setString(10,station);
       ps1.setString(11,section);
       ps1.setString(12,section);
       ps1.setString(13,frm_month_C);
       ps1.setString(14,frm_yr);
       ps1.setString(15,cur_month_C);
       ps1.setString(16,cur_yr);
...
ps1.close();
      ...
      ps1 = mk.con.prepareStatement( " select /*+ rule */  to_char(nvl(sum(trans_amt),0),'9999999990.999') from ("+
       ...
       ps1.setString(4,section);
       ps1.setString(5,section);
       ps1.setString(6,frmdt_C);
       ps1.setString(7,todt_C);
       ...
       ps1.setString(12,section);
       ps1.setString(13,section);
       ps1.setString(14,frmdt_M);
       ps1.setString(15,todt_M);
       ps1.setString(16,mon_basis);	   
       rs1 = ps1.executeQuery();
while(rs1.next()){
