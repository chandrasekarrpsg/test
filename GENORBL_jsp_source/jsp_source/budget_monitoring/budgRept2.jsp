...
<html>
    <head>
        ...
        <script>
            ...
            function getDtls(sMtdYtd,sFinYr,sMon,sMontr,sStn,sDept,sGrp){
        ...
        <center>
            ...
            <form name="form_1" action = "budgRept2.jsp" method="post" target="_self">
                <div style="background-color : #deffdd">
                    <table>
                        <tr>
                            <td width="25%" align="left">Station-&gt;Dept-&gt;Group
                            </td>
    ...
    form_1.sMontr[1].checked = 1;
            ...
            <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  1start-->
                ...
                <tbody><!--  1start-->
                    ...
                    <%
                                                        ...
                                                        List lstStnDtls = null;
                                                        List lstDeptDtls = null;
                                                        List lstGrpDtls = null;
                                                        List lstContrMatrDtls = null;
                                                        //List rows = null;
                                                        //Iterator iterateOuter = null;
                                                        //Iterator iterateInner = null;
                                                        ...
                                                        lstStnDtls = hRemote.getStnDtls(sFinYr, sMon, sMontr, "");


                                                        iterateOuter = lstStnDtls.iterator();
                                                        int i = 0;
                                                        while (iterateOuter.hasNext()) {
                                                            rows = (List) iterateOuter.next();
                                                            iterateInner = rows.iterator();
                        ...
                        <td colspan="9">
                            <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%>' style="display : none" ><!--  1start-->
                                <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  2start-->
                                    ...
                                    <tbody><!--  2start-->
                                        <%
                                                                            lstDeptDtls = hRemote.getDeptDtls(sFinYr, sMon, sMontr, "", sStn);
                                                                            iterateOuter_2 = lstDeptDtls.iterator();
                                                                            int j = 0;
                                                                            while (iterateOuter_2.hasNext()) {
                                                                                rows = (List) iterateOuter_2.next();
                                                                                iterateInner_2 = rows.iterator();
                                                                                while (iterateInner_2.hasNext()) {
                                                                                    sDept = (String) iterateInner_2.next();
                                        ...
                                        <tr bgcolor = "#99ccff">
                                            <%                                                                                                                       }
                                            %>
                                            <td><img name="img<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>" src="Pics/Order/plus_1.png" style="width : 20px ; height : 20px ; cursor : pointer" onclick = "clickImg(this);"/></td>
                                            <td><%= sDept%></td>
                                            <td><%= sMTDBudg%></td>
                                            <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','')"><%= sMTDAct%></a></td>
                                            <td><%= sMTDAbsDev%></td>
                                            <td><%= sMTDAbsDevPctg%></td>
                                            <td><%= sYTDBudg%></td>
                                            <td><a href="#" onclick="getDtls('ytd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','')"><%= sYTDAct%></a></td>
                                            <td><%= sYTDAbsDev%></td>
                                            <td><%= sYTDAbsDevPctg%></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>' style="display : none"><!--  2start-->
                                                    <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  3start-->
                                                        ...
                                                        <tbody><!--  3start-->
                                                            <%
                                                                                                                                            lstGrpDtls = hRemote.getGrpDtls(sFinYr, sMon, sMontr, sStn, sDept);
                                                                                                                                            iterateOuter_3 = lstGrpDtls.iterator();
                                                                                                                                            int k = 0;
                                                            ...
                                                            <tr bgcolor="#e6e2da">
                                                                <%                                                                                                                                                                                                             }
                                                                %>
                                                                <td><img name="img<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 1)%>" src="Pics/Order/plus_1.png" style="width : 20px ; height : 20px ; cursor : pointer" onclick = "clickImg(this);"/></td>
                                                                <td><%= sGrp%></td>
                                                                <td><%= sMTDBudg%></td>
                                                                <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','<%= sGrp.substring(0, 1)%>')"><%= sMTDAct%></a></td>
                                                                <td><%= sMTDAbsDev%></td>
                                                                <td><%= sMTDAbsDevPctg%></td>
                                                                <td><%= sYTDBudg%></td>
                                                                <td><a href="#" onclick="getDtls('ytd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','<%= sGrp.substring(0, 1)%>')"><%= sYTDAct%></a></td>
                                                                <td><%= sYTDAbsDev%></td>
                                                                <td><%= sYTDAbsDevPctg%></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="9">
                                                                    ...
                                                                    <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 1)%>' style="display : none"><!--  3start-->
                                                                        <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="580"><!--  4start-->
                                                                            ...
                                                                            <tbody><!--  4start-->
                                                                                <%
                                                                                                                                                                                                                                lstContrMatrDtls = hRemote.getMonDtls(sFinYr, sStn, sMontr, sDept, sGrp.substring(0, 1));
                                                                                                                                                                                                                                iterateOuter_4 = lstContrMatrDtls.iterator();
                                                                                                                                                                                                                                int l = 0;
                                                                                ...
                                                                                <tr bgcolor="#d991d8">
                                                                                    ...
                                                                                    <td><%= sMmOrd%></td>
                                                                                    <td><%= sMTDBudg%></td>
                                                                                    <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sTmpMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','<%= sGrp.substring(0, 1)%>')"><%= sMTDAct%></a></td>
                                                                                    <td><%= sMTDAbsDev%></td>
                                                                                    <td><%= sMTDAbsDevPctg%></td>
                                                                                </tr>
                                                                                <%
                                                            ...
                                                            animatedcollapse.addDiv('div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%><%= sGrp.substring(0, 1)%>', 'optional_attribute_string')
                                                        </script>
                                                        <%
                                                                                                                                        } //end while 3 %>
                                                        </tbody><!--  4end-->
                                    ...
                                    <script>
                                        animatedcollapse.addDiv('div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>', 'optional_attribute_string')
                                    </script>
                                    <%
                                                                        }
                                    %>
        ...
        <form name="form_2" action="budgReptDtls2.jsp" method="post" target="_blank">
            ...
            <input type="hidden" name="sDept" value="" />
