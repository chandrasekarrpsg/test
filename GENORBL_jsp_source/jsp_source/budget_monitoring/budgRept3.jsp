...
<html>
    <head>
        ...
        <script>
            ...
            function getDtls(sMtdYtd,sFinYr,sMon,sMontr,sStn,sDept,sBudgHd){
    ...
    <body onload="if(i == 1){animatedcollapse.hide('div_img')}">
        <center>
            ...
            <br>
            <form name="form_1" action = "budgRept3.jsp" method="post" target="_self">
                <div style="background-color : #deffdd">
                    <table>
                        <tr>
                            <td width="25%" align="left">Station-&gt;Dept-&gt;Budget
                            </td>
            ...
            <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  1start-->
                ...
                <tbody><!--  1start-->
                    ...
                    <%
                                                ...
                                                lstStnDtls = hRemote.getStnDtls(sFinYr, sMon, sMontr, "2b");
                    ...
                    <tr bgcolor="#e4d437">
                        ...
                        <td><%= sStn%></td>
                        <td><%= sMTDBudg%></td>
                        <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','','x')"><%= sMTDAct%></a></td>
                        <td><%= sMTDAbsDev%></td>
                        <td><%= sMTDAbsDevPctg%></td>
                        <td><%= sYTDBudg%></td>
                        <td><a href="#" onclick="getDtls('ytd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','','x')"><%= sYTDAct%></a></td>
                        <td><%= sYTDAbsDev%></td>
                        ...
                        <td colspan="9">
                            <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%>' style="display : none" ><!--  1start-->
                                <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  2start-->
                                    ...
                                    <tbody><!--  2start-->
                                        <%
                                                                                            lstDeptDtls = hRemote.getDeptDtls(sFinYr, sMon, sMontr, "2b", sStn);
                                        ...
                                        <tr bgcolor = "#99ccff">
                                            ...
                                            <td><%= sDept%></td>
                                            <td><%= sMTDBudg%></td>
                                            <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','x')"><%= sMTDAct%></a></td>
                                            <td><%= sMTDAbsDev%></td>
                                            <td><%= sMTDAbsDevPctg%></td>
                                            <td><%= sYTDBudg%></td>
                                            <td><a href="#" onclick="getDtls('ytd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','x')"><%= sYTDAct%></a></td>
                                            <td><%= sYTDAbsDev%></td>
                                            <td><%= sYTDAbsDevPctg%></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <div id='div<%= sStn.replace("(", "").replace(")", "").replace("-", "_")%><%= sDept.replace("(", "").replace(")", "").replace("-", "_")%>' style="display : none"><!--  2start-->
                                                    <table cellspacing="1" cellpadding="2" id="myScrollTable_1" width="880"><!--  3start-->
                                                        ...
                                                        <tbody><!--  3start-->
                                                            <%
                                                                                                                                                                    lstGrpDtls = hRemote.getBudgDtls(sFinYr, sMon, sMontr, "2b", sStn, sDept);
                                                                                                                                                                    ...
                                                                                                                                                                    while (iterateOuter_3.hasNext()) {
                                                                                                                                                                        ...
                                                                                                                                                                        while (iterateInner_3.hasNext()) {
                                                                                                                                                                            sBudgHd = (String) iterateInner_3.next();
                                                            ...
                                                            <tr bgcolor="#e6e2da">
                                                                ...
                                                                <td><%= sBudgHd%></td>
                                                                <td><%= sMTDBudg%></td>
                                                                <td><a href="#" onclick="getDtls('mtd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','<%= sBudgHd%>')"><%= sMTDAct%></a></td>
                                                                <td><%= sMTDAbsDev%></td>
                                                                <td><%= sMTDAbsDevPctg%></td>
                                                                <td><%= sYTDBudg%></td>
                                                                <td><a href="#" onclick="getDtls('ytd','<%= sFinYr%>','<%= sMon%>','<%= sMontr%>','<%= sStn%>','<%= sDept%>','<%= sBudgHd%>')"><%= sYTDAct%></a></td>
                                                                <td><%= sYTDAbsDev%></td>
                                                                <td><%= sYTDAbsDevPctg%></td>
                                                            </tr>
        ...
        <form name="form_2" action="budgReptDtls3.jsp" method="post" target="_blank">
