...
<tr>   
 ...
 <td colspan="5" align="center">
     <input type="text" name="T1" size="51" maxlength = "6" readOnly="true"   style="color: CC6600 ; border:1px solid  #FFFFCC; background-color: #FFFFCC; font-weight:bold">    
    </td>
  </tr>
...
<tr>   
 ...
 <td colspan="2" align="center">
     <input type="text" name="T2" size="25" maxlength = "25" readOnly="true"   style="color: CC6600 ; border:1px solid  #FFFFCC; background-color: #FFFFCC; font-weight:bold">    
    </td>
 ...
 <td colspan="2" align="center">
     <input type="text" name="T3" size="25" maxlength = "25" readOnly="true"   style="color: CC6600 ; border:1px solid  #FFFFCC; background-color: #FFFFCC; font-weight:bold">    
    </td>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T4" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T5" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
</tr>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T6" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T7" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
</tr>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T8" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
<a href="JavaScript:;" onClick="toggleCalendar('T8')">
 ...
 <td colspan="2" align="center">
    <input type="text" name="T9" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
<a href="JavaScript:;" onClick="toggleCalendar('T9')">
        <img border="0" src="calButton.bmp" width="18" height="24"></a>    
    </td>
</tr>
 ...
 <td colspan="5" align="center">
    <input type="text" name="T10" size="25" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
</tr>
 ...
 <td colspan="2" align="center">
    <input type="text" name="T11" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
  

 <td colspan="3" align="center">
    <input type="text" name="T12" size="20" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
</tr>
 ...
 <td colspan="5" align="center">
    <input type="text" name="T13" size="25" maxlength = "51" readOnly="true" style="color: CC6600 ; border:1px   solid #FFFFCC; background-color: #FFFFCC; font-weight:bold">     
    </td>
</tr>
