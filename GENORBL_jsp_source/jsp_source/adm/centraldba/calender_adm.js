...
var srtmonths = new Array("JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC");
...
//alert('today='+today.year+today.month+today.day);
	...
	for (var intWeek = 0; intWeek < tableCal.rows.length;  intWeek++)
	 ...
	 function getTodayDay()
	 {
			    document.all[element_id].value = today.day + "/" + (today.month+1) + "/" + today.year; 
                           alert(document.all[element_id].value);
        ...
        function getDate() 
		 {
            ...
            if ("TD" == event.srcElement.tagName)
			   ...
			   { 
				 ...
				 //document.all[element_id].value=day+"/"+mn +"/"  +Year;
				 document.all[element_id].value=day+"-"+srtmonths[mn-1] +"-"  +Year;
		                 //document.all.calendar.style.visibility="hidden";
				 document.all.calendar.style.display="none";
                                 //setDt();
			 }
