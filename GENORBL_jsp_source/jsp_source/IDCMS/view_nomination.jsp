...
function search (){
   var parameter='';
   parameter = parameter + '&job_mnth_from='+document.getElementById("job_mnth_from").value;
   parameter = parameter + '&job_mnth_to='+document.getElementById("job_mnth_to").value;
...
//alert(parameter);
window.open("search_nom.jsp?"+parameter,"_self");
}
...
try{
           ...
           ps = mk.con.prepareStatement("select trim(to_char(add_months(trunc(sysdate),-1),'MON-YY')) from dual");
           rs = ps.executeQuery();
           while(rs.next()){
                cur_mnthyr = rs.getString(1);
           }
           rs.close();
           ps.close();
%>
...
<br>
        <div id="formdiv" align="center">
          From Month-Year : &nbsp;&nbsp; 
         <input type="text" name="job_mnth_from" id="job_mnth_from" size="6" value="<%=cur_mnthyr%>"  onclick="sel_month('f1.job_mnth_from','js/');"  />
          &nbsp;&nbsp;To Month-Year : &nbsp;&nbsp; 
         <input type="text" name="job_mnth_to" id="job_mnth_to" size="6" value="<%=cur_mnthyr%>"  onclick="sel_month('f1.job_mnth_to','js/');"  />
         &nbsp;&nbsp;Station:&nbsp;
            <select id="office">
...
%>
          ...
          Title : &nbsp;&nbsp; 
         <input type="text" name="title" id="title" size="10" value=""  onclick=""  />
          &nbsp;&nbsp; 
            &nbsp;&nbsp;&nbsp;&nbsp;
