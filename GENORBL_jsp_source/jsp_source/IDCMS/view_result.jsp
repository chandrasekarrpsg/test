...
//alert(parameter);
window.open("search_res.jsp?"+parameter,"_self");
...
<b><font face="Book Antiqua" color="#800000" size="4">Enter Your Keywords Here To Search Result</font></b>
</label>
...
Month Year: &nbsp;&nbsp; <input type="text" name="job_mnth" id="job_mnth"  onclick="sel_month('f1.job_mnth','js/');"  />
           &nbsp;&nbsp;Title:&nbsp;&nbsp;<input type="text" name="title" id="title"  onclick=""  />&nbsp;&nbsp;
