...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/idcms/ipicms_nomination_script_new_ver2.js"></script>
        ...
        <script>
            ...
            function preScript(){
                f1.sCall_from.value = 'preScript';

                if( document.f1.sContestId.value == '' ){

                    animatedcollapse.hide('div_block2');
                    animatedcollapse.hide('div_block3');
                    animatedcollapse.hide('div_block4');
                    animatedcollapse.hide('div_block5');
                    animatedcollapse.hide('div_block6');

                }else{
                    if( document.f1.sStg.value == '0' ){
                        animatedcollapse.hide('div_block2');
                        animatedcollapse.hide('div_block3');
                        animatedcollapse.hide('div_block4');
                        animatedcollapse.hide('div_block5');
                        ...
                        animatedcollapse.show('div_block2');
                        animatedcollapse.show('div_block3');
                        animatedcollapse.show('div_block4');
                        animatedcollapse.show('div_block5');
                        animatedcollapse.show('div_block6');
                    }
                }
                ...
                $('#sSymptom').characterCountdown({
                    ...
                    maxChars: 150 //  the maximum amount of characters
                });
                ...
                if( f1.hOther_analysis.value == 'Y' ){
                    $('input[name="sOther_analysis"]')[0].checked = true ;
                    clkOther_analysis();
                }
                ...
                if( f1.hInnovative_place_work.value == 'Y' ){
                    $('input[name="sInnovative_place_work"]')[0].checked = true ;
                }else if( f1.hInnovative_place_work.value == 'N' ){
                    $('input[name="sInnovative_place_work"]')[1].checked = true ;
                }
                if( f1.hInnovative_place_dept.value == 'Y' ){
                    $('input[name="sInnovative_place_dept"]')[0].checked = true ;
                }else if( f1.hInnovative_place_dept.value == 'N' ){
                    $('input[name="sInnovative_place_dept"]')[1].checked = true ;
                }
                if( f1.hInnovative_place_cesc.value == 'Y' ){
                    $('input[name="sInnovative_place_cesc"]')[0].checked = true ;
                    attach_innovative_place_cesc();
                }
                if( f1.hInnovative_none.value == 'Y' ){
                    $('input[name="sInnovative_none"]')[0].checked = true ;
                }
                if( f1.hReplicated_from_cesc.value == 'Y' ){
                    $('input[name="sReplicated_from_cesc"]')[0].checked = true ;
                    $('#spanUniqueness_1').after('<span id="spanUniqueness_2">mention source&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span> <input type="text" name="sUniqueness_remarks" id="sUniqueness_remarks"></span>');
                    $('#sUniqueness_remarks').val($('#hUniqueness_remarks').val());
                }else if( f1.hReplicated_from_cesc.value == 'N' ){
                    $('input[name="sReplicated_from_cesc"]')[1].checked = true ;
                }
                if( f1.hReplicated_from_oth_industry.value == 'Y' ){
                    $('input[name="sReplicated_from_oth_industry"]')[0].checked = true ;
                    $('#spanUniqueness_1').after('<span id="spanUniqueness_2">mention source&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span> <input type="text" name="sUniqueness_remarks" id="sUniqueness_remarks"></span>');
                    $('#sUniqueness_remarks').val($('#hUniqueness_remarks').val());
                }else if( f1.hReplicated_from_oth_industry.value == 'N' ){
                    $('input[name="sReplicated_from_oth_industry"]')[1].checked = true ;
                }
                if( f1.hCompletely_unique.value == 'Y' ){
                    $('input[name="sCompletely_unique"]')[0].checked = true ;
                    $('#spanUniqueness_1').after('<span id="spanUniqueness_2">mention the uniqueness part <input type="text" name="sUniqueness_remarks" id="sUniqueness_remarks"></span>');
                    $('#sUniqueness_remarks').val($('#hUniqueness_remarks').val());
                }else if( f1.hCompletely_unique.value == 'N' ){
                    $('input[name="sCompletely_unique"]')[1].checked = true ;
                }

                if( f1.hReplication_in_dept.value == 'Y' ){
                    $('input[name="sReplication_in_dept"]')[0].checked = true ;
                }else if( f1.hReplication_in_dept.value == 'N' ){
                    $('input[name="sReplication_in_dept"]')[1].checked = true ;
                }

                if( f1.hReplication_in_oth_cesc.value == 'Y' ){
                    $('input[name="sReplication_in_oth_cesc"]')[0].checked = true ;
                }else if( f1.hReplication_in_oth_cesc.value == 'N' ){
                    $('input[name="sReplication_in_oth_cesc"]')[1].checked = true ;
                }

                if( f1.hReplication_in_industry.value == 'Y' ){
                    $('input[name="sReplication_in_industry"]')[0].checked = true ;
                }else if( f1.hReplication_in_industry.value == 'N' ){
                    $('input[name="sReplication_in_industry"]')[1].checked = true ;
                }
                //--------------------------END Block D---------------------------------------//
            ...
            var validate_form_block1 = function(){
                ...
                if( document.f1.hValidation_typ.value != 'all' ){
            ...
            var chkSymptom = function(){
                ...
                if( parseInt(no_of_char,10) < 0 ){
                    alert('You have entered more than maximum allowable characters(150) for symptom/pain !');
                    $('#sSymptom').focus();
                    $('#sSymptom').select();
                    return false;
                }
            ...
            var chkRoot_cause_analysis = function(){
                ...
                if( $('input[name="sOther_analysis"]')[0].checked == true ){
                    iCnt++ ;
                }
            ...
            var chkOther_analysis_name = function(){

                if( $('input[name="sOther_analysis"]')[0].checked == true && myTrim($('input[name="sOther_analysis_name"]').val()) == '' ){
                    alert('Please write Appropriate Name of tool !');
                    $('input[name="sOther_analysis_name"]').focus();
                    $('input[name="sOther_analysis_name"]').select();
                    return false;
                }
                return true ;
            }

            var chkNone_analysis_reason = function(){

                if( $('input[name="sNone_analysis"]')[0].checked == true && myTrim($('input[name="sNone_analysis_reason"]').val()) == '' ){
                    alert('Please mention reasons for non-applicability !');
                    $('input[name="sNone_analysis_reason"]').focus();
                    $('input[name="sNone_analysis_reason"]').select();
                    return false;
                }
                return true ;
            }
            ...
            var chkAttach_root_cause_analysis = function(){
                ...
                if( $('input[name="sWhy_why_analysis"]')[0].checked == true && document.f1.sNoFl_4_w.value == 0 && document.f1.sNoFl_4_wp.value == 0 && document.f1.sNoFl_4_wf.value == 0 && document.f1.sNoFl_4_wo.value == 0 && document.f1.sNoFl_4_wpf.value == 0 && document.f1.sNoFl_4_wpo.value == 0 && document.f1.sNoFl_4_wfo.value == 0 && document.f1.sNoFl_4_wpfo.value == 0 ){
                    alert('Please upload atleast one attachment for Why Why Analysis !');
                    return false ;
                }
                if( $('input[name="sPareto_analysis"]')[0].checked == true && document.f1.sNoFl_4_p.value == 0 && document.f1.sNoFl_4_wp.value == 0 && document.f1.sNoFl_4_pf.value == 0 && document.f1.sNoFl_4_po.value == 0 && document.f1.sNoFl_4_wpf.value == 0 && document.f1.sNoFl_4_wpo.value == 0 && document.f1.sNoFl_4_pfo.value == 0 && document.f1.sNoFl_4_wpfo.value == 0 ){
                    alert('Please upload atleast one attachment for Pareto Analysis !');
                    return false ;
                }
                if( $('input[name="sFish_bone_diagram"]')[0].checked == true && document.f1.sNoFl_4_f.value == 0 && document.f1.sNoFl_4_wf.value == 0 && document.f1.sNoFl_4_pf.value == 0 && document.f1.sNoFl_4_fo.value == 0 && document.f1.sNoFl_4_wpf.value == 0 && document.f1.sNoFl_4_wfo.value == 0 && document.f1.sNoFl_4_pfo.value == 0 && document.f1.sNoFl_4_wpfo.value == 0 ){
                    alert('Please upload atleast one attachment for Fish Bone Diagram !');
                    return false ;
                }
                if( $('input[name="sOther_analysis"]')[0].checked == true && document.f1.sNoFl_4_o.value == 0 && document.f1.sNoFl_4_wo.value == 0 && document.f1.sNoFl_4_po.value == 0 && document.f1.sNoFl_4_fo.value == 0 && document.f1.sNoFl_4_wpo.value == 0 && document.f1.sNoFl_4_wfo.value == 0 && document.f1.sNoFl_4_pfo.value == 0 && document.f1.sNoFl_4_wpfo.value == 0 ){
                    alert('Please upload atleast one attachment for Other Problem solving tool !');
                    return false ;
                }
                return true ;
            }
            ...
            var clkWhy_why_analysis = function(){

                if( $('input[name="sWhy_why_analysis"]')[0].checked == true || $('input[name="sPareto_analysis"]')[0].checked == true || $('input[name="sFish_bone_diagram"]')[0].checked == true || $('input[name="sOther_analysis"]')[0].checked == true ){
                    $("#td_document_tools").html("C4. Attach Analysis document against each of the tools used for analysis (Preferably Pdf and/or jpg)&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span>");
                }else{
                    $("#td_document_tools").html("C4. Attach Analysis document against each of the tools used for analysis (Preferably Pdf and/or jpg)");
                }
                return true;
            }

            var clkPareto_analysis = function(){
            ...
            var clkFish_bone_diagram = function(){
            ...
            var clkNone_analysis = function(){
                $('#spanNone_analysis_reason').remove();
                $('#spanOther_analysis_name').remove();
                $("#td_document_tools").html("C4. Attach Analysis document against each of the tools used for analysis (Preferably Pdf and/or jpg)");
                if( $('input[name="sNone_analysis"]')[0].checked == true ){
                    ...
                    $('input[name="sOther_analysis"]')[0].checked = false;
                    $('input[name="sOther_analysis"]')[0].disabled = true;
                    $('#spanNone_analysis').after("<span id='spanNone_analysis_reason'></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please mention reasons for non-applicability&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span>&nbsp;&nbsp;<input type='textbox' name='sNone_analysis_reason' id='sNone_analysis_reason' maxlength='50' size='30'></span>")
                    $('#sNone_analysis_reason').val($('#hNone_analysis_reason').val());
                }else{
                    ...
                    $('input[name="sOther_analysis"]')[0].disabled = false;
                }
            ...
            var clkOther_analysis = function(){
                $('#spanNone_analysis_reason').remove();
                $('#spanOther_analysis_name').remove();

                if( $('input[name="sOther_analysis"]')[0].checked == true ){
                    $('#spanNone_analysis').after("<span id='spanOther_analysis_name'></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please name appropriate name of tool&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span>&nbsp;&nbsp;<input type='textbox' name='sOther_analysis_name' id='sOther_analysis_name' maxlength='50' size='30'></span>")
                    $('#sOther_analysis_name').val($('#hOther_analysis_name').val());
                }
            ...
            var select_file_upld_cause = function(){
                ...
                if( $('input[name="sOther_analysis"]')[0].checked == true ){
                    html1 += "<input type='checkbox' name='sFile_upld_cause_o' id='sFile_upld_cause_o'>&nbsp;Any Other Problem solving tool</br>"
                    i += 1 ;
                }

                if( $('input[name="sNone_analysis"]')[0].checked == true ){
                    html1 += "<input type='checkbox' name='sFile_upld_cause_n' id='sFile_upld_cause_n'>&nbsp;Use of Tool not applicable</br>"
                    i += 1 ;
                }
                ...
                if( i > 1 ){
                    ...
                    if( $('input[name="sWhy_why_analysis"]')[0].checked == true ){
                        $('input[name="sFile_upld_cause_w"]')[0].checked = true ;
                    }
                    if( $('input[name="sPareto_analysis"]')[0].checked == true ){
                        $('input[name="sFile_upld_cause_p"]')[0].checked = true ;
                    }
                    if( $('input[name="sFish_bone_diagram"]')[0].checked == true ){
                        $('input[name="sFile_upld_cause_f"]')[0].checked = true ;
                    }
                    if( $('input[name="sOther_analysis"]')[0].checked == true ){
                        $('input[name="sFile_upld_cause_o"]')[0].checked = true ;
                    }
                    if( $('input[name="sNone_analysis"]')[0].checked == true ){
                        $('input[name="sFile_upld_cause_n"]')[0].checked = true ;
                    }
                    file_upld_cause();
                }
            ...
            var file_upld_cause = function(){
                ...
                if( $('input[name="sFile_upld_cause_o"]')[0] != undefined && $('input[name="sFile_upld_cause_o"]')[0].checked == true ){
                    sSub_typ = sSub_typ + 'o';
                    iCnt++ ;
                }
            ...
            var chkInnovative = function(){
                ...
                if( $("input[name='sInnovative_place_work']:checked").val() == undefined && $("input[name='sInnovative_place_dept']:checked").val() == undefined && $('input[name="sInnovative_place_cesc"]')[0].checked == false && $('input[name="sInnovative_none"]')[0].checked == false ){
                    alert('Please select a value from Innovative section !');
                    return false ;
                }

                /*if( $("input[name='sInnovative_place_work']:checked").val() == undefined ){
                    alert('Please select a value from Innovative section (First Time at workplace/area of work) !');
                    return false ;
                }

                if( $("input[name='sInnovative_place_dept']:checked").val() == undefined ){
                    alert('Please select a value from Innovative section (First Time within Department/Division) !');
                    return false ;
                }*/
            ...
            var chkAttach_innovative_cesc = function(){

                if( $('input[name="sInnovative_place_cesc"]')[0].checked == true && f1.sNoFl_5.value == 0 ){
                    alert('Please attach atleast one Evidence of Claim that this is first time in CESC/in industry !')
                    return false ;
                }
                return true ;
            }
            ...
            var chkUniqueness = function(){
                ...
                if( $("input[name='sReplicated_from_cesc']:checked").val() == undefined ){
                    alert('Please select a value from Uniqueness section (Replicated from elsewhere within CESC) !');
                    return false ;
                }

                if( $("input[name='sReplicated_from_oth_industry']:checked").val() == undefined ){
                    alert('Please select a value from Uniqueness section (Replicated from other industry) !');
                    return false ;
                }

                if( $("input[name='sCompletely_unique']:checked").val() == undefined ){
                    alert('Please select a value from Uniqueness section (Completely new/Unique solution) !');
                    return false ;
                }
            ...
            var chkUniqueness_remarks = function(){

                if( $('input[name="sReplicated_from_cesc"]')[0].checked == true && myTrim($('#sUniqueness_remarks').val()) == '' ){
                    alert('Please mention source !');
                    $('#sUniqueness_remarks').focus();
                    $('#sUniqueness_remarks').select();
                    return false;
                }

                if( $('input[name="sReplicated_from_oth_industry"]')[0].checked == true && myTrim($('#sUniqueness_remarks').val()) == '' ){
                    alert('Please mention source !');
                    $('#sUniqueness_remarks').focus();
                    $('#sUniqueness_remarks').select();
                    return false;
                ...
                if( $('input[name="sCompletely_unique"]')[0].checked == true && myTrim($('#sUniqueness_remarks').val()) == '' ){
                    alert('Please mention the uniqueness part !');
                    $('#sUniqueness_remarks').focus();
                    $('#sUniqueness_remarks').select();
                    return false;
                }
            ...
            var chkReplication_in_dept = function(){
                if( $("input[name='sReplication_in_dept']:checked").val() == undefined ){
                    alert('Please specify Scope of Replication elsewhere (Within Same Section/Dept.) !');
                    return false ;
                }
            ...
            var chkReplication_in_oth_cesc = function(){
                if( $("input[name='sReplication_in_oth_cesc']:checked").val() == undefined ){
                    alert('Please specify Scope of Replication elsewhere (Within other areas in CESC) !');
                    return false ;
                }
            ...
            var chkReplication_in_industry = function(){
                if( $("input[name='sReplication_in_industry']:checked").val() == undefined ){
                    alert('Please specify Scope of Replication elsewhere (Across Power Industry) !');
                    return false ;
                }
                        ...
                        $(element).children().each(function(index2,element2){
                            ...
                            if( index2 == 1 ){
                                if( !$parent.is($(element2)) ){
                                    ...
                                    $(element2).html("<input type='radio' name='hFinally_implemented_soln' value=\"\" checked onclick='clkFinally_implemented_soln(this)'/>Date of implementation&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span> <input type='text' name='sDate_of_implementation' id='sDate_of_implementation' size='8' onclick='sel_date_cls(\"f1.sDate_of_implementation\",\"js/\")' value=''/>");
            ...
            var clkOther_soln = function(){
                ...
                if( $('input[name="sOther_soln"]')[0].checked == true ){
                    ...
                    $('#sConsider_for_best_soln').after('<td id="td_other_soln" valign="top" colspan="2">'
                        ...
                        +      '<option value="2">Impact on bottomline'
            ...
            var clkInnovative_place_work = function(){

                if( $('input[name="sInnovative_place_work"]')[0].checked == true ){

                    $('input[name="sInnovative_place_dept"]')[0].checked = false;
                    $('input[name="sInnovative_place_dept"]')[1].checked = true;

                }else if( $('input[name="sInnovative_place_work"]')[1].checked == true ){
            ...
            var clkInnovative_place_dept = function(){

                if( $('input[name="sInnovative_place_dept"]')[0].checked == true ){

                    $('input[name="sInnovative_place_work"]')[0].checked = true;
                    $('input[name="sInnovative_place_work"]')[0].disabled = true;
                    $('input[name="sInnovative_place_work"]')[1].disabled = true;

                }else if( $('input[name="sInnovative_place_dept"]')[1].checked == true ){

                    $('input[name="sInnovative_place_work"]')[0].disabled = false;
                    $('input[name="sInnovative_place_work"]')[1].disabled = false;
            ...
            var attach_innovative_place_cesc = function(){

                $('#tr_D5D6D7').after('<tr id="tr_attach_innovative_cesc"><td colspan="3"><table width="70%" id="tab_attach_innovative_cesc">'
                    +       '<tr class="thdr" id="tr_attach_innovative_cesc">'
                    +       '<td colspan="2">'+'Attach Evidence of Claim (First Time in CESC/in Industry) (Preferably Pdf and/or jpg)&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span>'+'</td>'
                    +       '</tr>'
                    +       '<tr>'
                    +       '<td valign="top" width="20%">'
                    +       '<table class="table" id="tabFl_5">'
                    ...
                    +       '<br/>'
                    +       '<center>'
                    +       '<div id="divDelFl_5" style="width: 20px; background : #000040; display:none">'
                    +       '<input type="button" value="Delete File" name="butnDelFl_5" style="background-color : #ffffff" onclick="delFl(\'innovative\');">'
                    +       '</div>'
                    +       '</center>'
                    +       '</td>'
                    +       '<td valign="top" width="30%">'
                    +       '<iframe id ="iFrameUpldFl_5" name ="iFrameUpldFl_5" src="ipicms_upldFl.jsp?sContestId='+f1.sContestId.value+'&sIpAddr='+f1.sIpAddr.value+'&sTyp=innovative" height="140px" width="350px" frameborder="0">'
                    +       '</iframe>'
                    +       '</td>'
                    +       '</tr>'
                    +       '</table></td></tr>');
                $('#td_pic_after').attr('rowspan',6);

                if( f1.sCall_from.value != 'preScript' ){
                    getPicFlNms('innovative');
                }

                return true ;
            }

            var clkInnovative_place_cesc = function(){
                $('#tr_attach_innovative_cesc').remove();
                $('#td_pic_after').attr('rowspan',5);
                if( $('input[name="sInnovative_place_cesc"]')[0].checked == true ){

                    $('input[name="sInnovative_place_dept"]')[0].checked = true;
                    $('input[name="sInnovative_place_dept"]')[0].disabled = true;
                    $('input[name="sInnovative_place_dept"]')[1].disabled = true;

                    attach_innovative_place_cesc();

                }else{
                    
                    $('input[name="sInnovative_place_dept"]')[0].disabled = false;
                    $('input[name="sInnovative_place_dept"]')[1].disabled = false;

                }

                clkInnovative_place_dept();
            ...
            var clkInnovative_none = function(){
                ...
                if( $('input[name="sInnovative_none"]')[0].checked == true ){
                    $('input[name="sInnovative_place_work"]')[0].checked = false;
                    $('input[name="sInnovative_place_work"]')[0].disabled = true;
                    $('input[name="sInnovative_place_work"]')[1].checked = false;
                    $('input[name="sInnovative_place_work"]')[1].disabled = true;
                    $('input[name="sInnovative_place_dept"]')[0].checked = false;
                    $('input[name="sInnovative_place_dept"]')[0].disabled = true;
                    $('input[name="sInnovative_place_dept"]')[1].checked = false;
                    $('input[name="sInnovative_place_dept"]')[1].disabled = true;
                    $('input[name="sInnovative_place_cesc"]')[0].checked = false;
                    $('input[name="sInnovative_place_cesc"]')[0].disabled = true;
                    ...
                    $('input[name="sInnovative_place_dept"]')[0].disabled = false;
                    $('input[name="sInnovative_place_dept"]')[1].disabled = false;
                    $('input[name="sInnovative_place_cesc"]')[0].disabled = false;
                }

                //clkInnovative_place_cesc();

                return true ;

            }

            var clkReplicated_from_cesc = function(){
                $('#spanUniqueness_2').remove();
                if( $('input[name="sReplicated_from_cesc"]')[0].checked == true ){
                    $('input[name="sReplicated_from_oth_industry"]')[0].checked = false;
                    $('input[name="sReplicated_from_oth_industry"]')[1].checked = true;
                    $('input[name="sCompletely_unique"]')[0].checked = false;
                    $('input[name="sCompletely_unique"]')[1].checked = true;
                    $('#spanUniqueness_1').after('<span id="spanUniqueness_2">mention source&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span> <input type="text" name="sUniqueness_remarks" id="sUniqueness_remarks"></span>');
                    $('#sUniqueness_remarks').val($('#hUniqueness_remarks').val());
                }else{
            ...
            var clkReplicated_from_oth_industry = function(){
                $('#spanUniqueness_2').remove();
                if( $('input[name="sReplicated_from_oth_industry"]')[0].checked == true ){
                    $('input[name="sReplicated_from_cesc"]')[0].checked = false;
                    $('input[name="sReplicated_from_cesc"]')[1].checked = true;
                    $('input[name="sCompletely_unique"]')[0].checked = false;
                    $('input[name="sCompletely_unique"]')[1].checked = true;
                    $('#spanUniqueness_1').after('<span id="spanUniqueness_2">mention source&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span> <input type="text" name="sUniqueness_remarks" id="sUniqueness_remarks"></span>');
            ...
            var clkCompletely_unique = function(){
                $('#spanUniqueness_2').remove();
                if( $('input[name="sCompletely_unique"]')[0].checked == true ){
                    $('input[name="sReplicated_from_cesc"]')[0].checked = false;
                    $('input[name="sReplicated_from_cesc"]')[1].checked = true;
                    $('input[name="sReplicated_from_oth_industry"]')[0].checked = false;
                    $('input[name="sReplicated_from_oth_industry"]')[1].checked = true;
            ...
            var clkBenefit_of_improve_continue = function(){
                ...
                if( $('input[name="sBenefit_of_improve_continue"]')[0].checked == true ){//Y
                    //$('#spanBenefit_of_improve_continue').after("<span id='spanExpenses_incurred'><br/>Expenses Incurred(INR)&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span> <input type='text' name='sExpenses_incurred' id='sExpenses_incurred' style='text-align : right' onkeyup='if(window.event.keyCode == 13){genAttach_cost_sheet();}'/></span>");
                    ...
                    $('#spanSaving_potential').after("<span id='spanCost_of_investment_reqd'><br/>Have you incurred any cost (Cost of purchase/hiring) for this Kaizen ?&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span>  <input type='radio' name='sCost_of_investment_reqd' value='Y' onclick='clkCost_of_investment_reqd();'/> Y <input type='radio' name='sCost_of_investment_reqd' value='N' onclick='clkCost_of_investment_reqd();'/> N</span>");
                    ...
                    $('#spanBenefit_of_improve_continue').after("<span id='spanExpenses_incurred'><br/>Expenses Incurred(INR) <input type='text' name='sExpenses_incurred' id='sExpenses_incurred' style='text-align : right' onkeyup='if(window.event.keyCode == 13){genAttach_cost_sheet();}'/></span>");
                    $('#spanExpenses_incurred').after("<span id='spanCost_savings_investment'><br/>Cost savings out of this investment(Till date)(INR) <input type='text' name='sCost_savings_investment' id='sCost_savings_investment' style='text-align : right' onkeyup='if(window.event.keyCode == 13){genAttach_cost_sheet();}'/></span>");
                    ...
                    $('#sExpenses_incurred').val($('#hExpenses_incurred').val());
            ...
            var clkCost_of_investment_reqd = function(){
                ...
                if( $('input[name="sCost_of_investment_reqd"]')[0].checked == true ){
                    $('#spanCost_of_investment_reqd').after("<span id='spanExpenses_incurred'><br/>Expenses Incurred(INR)&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span> <input type='text' name='sExpenses_incurred' id='sExpenses_incurred' style='text-align : right' onkeyup='if(window.event.keyCode == 13){genAttach_cost_sheet();}'/></span>");
                    $('#spanExpenses_incurred').after("<span id='spanRoi_calculated'><br/>Return of Investment calculated ?&nbsp;<span style='color : red ; font-size : 12pt'><b>*</b></span>  <input type='radio' name='sRoi_calculated' value='Y' onclick='clkRoi_calculated();'/> Y <input type='radio' name='sRoi_calculated' value='N' onclick='clkRoi_calculated();'/> N</span>");
            ...
            function chkExpenses_incurred(){
    
                if( !isAmt( document.getElementById('sExpenses_incurred') ) )return false;
            ...
            var genAttach_cost_sheet = function(){
                ...
                if( $('input[name="sBenefit_of_improve_continue"]')[0].checked == true ){//Y
                    ...
                    if( parseFloat(0+f1.sCost_savings_investment.value) > 0.00 ){
                        ...
                        if( parseFloat(0+f1.sSaving_potential.value) > 0.00 ){
                            ...
                            if( $('input[name="sCost_of_investment_reqd"]')[0].checked == true ){
                                ...
                                if( $('input[name="sRoi_calculated"]')[0].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Cost savings, Saving Potential, Expenses incurred & Return on investment (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }else if( $('input[name="sRoi_calculated"]')[1].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Cost savings, Saving Potential & Expenses incurred (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }

                            }else if( $('input[name="sCost_of_investment_reqd"]')[1].checked == true ){
                                sStmt = 'Attach Cost calculation sheet for Cost savings & Saving Potential (Preferably Pdf and/or jpg)'
                            ...
                            if( $('input[name="sCost_of_investment_reqd"]')[0].checked == true ){
                                ...
                                if( $('input[name="sRoi_calculated"]')[0].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Cost savings, Expenses incurred & Return on investment (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }else if( $('input[name="sRoi_calculated"]')[1].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Cost savings & Expenses incurred (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }

                            }else if( $('input[name="sCost_of_investment_reqd"]')[1].checked == true ){
                                sStmt = 'Attach Cost calculation sheet for Cost savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanCost_of_investment_reqd';
                            }
                        ...
                        if( parseFloat(0+f1.sSaving_potential.value) > 0.00 ){
                            ...
                            if( $('input[name="sCost_of_investment_reqd"]')[0].checked == true ){
                                ...
                                if( $('input[name="sRoi_calculated"]')[0].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Saving Potential, Expenses incurred & Return on investment (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }else if( $('input[name="sRoi_calculated"]')[1].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Saving Potential & Expenses incurred (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }

                            }else if( $('input[name="sCost_of_investment_reqd"]')[1].checked == true ){
                                sStmt = 'Attach Cost calculation sheet for Saving Potential (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanCost_of_investment_reqd';
                            }
                            ...
                            if( $('input[name="sCost_of_investment_reqd"]')[0].checked == true ){
                                ...
                                if( $('input[name="sRoi_calculated"]')[0].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Expenses incurred & Return on investment (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }else if( $('input[name="sRoi_calculated"]')[1].checked == true ){
                                    sStmt = 'Attach Cost calculation sheet for Expenses incurred (Preferably Pdf and/or jpg)'
                                    attach_cost_sheet_after = 'spanRoi_calculated';
                                }
                    ...
                    if( f1.sExpenses_incurred.value == '' ){}
                    else{
                        if( chkExpenses_incurred() ){}
                        else return false ;
                    }
                    ...
                    if( parseFloat(0+f1.sExpenses_incurred.value) > 0.00 ){

                        if( parseFloat(0+f1.sCost_savings_investment.value) > 0.00 ){

                            if( parseFloat(0+f1.sNet_savings.value) > 0.00 ){
                                sStmt = 'Attach Cost calculation sheet for Expenses Incurred, Cost savings & Net Savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            }else{
                                sStmt = 'Attach Cost calculation sheet for Expenses Incurred & Cost savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            }

                        }else{
                            if( parseFloat(0+f1.sNet_savings.value) > 0.00 ){
                                sStmt = 'Attach Cost calculation sheet for Expenses Incurred & Net Savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            }else{
                                sStmt = 'Attach Cost calculation sheet for Expenses Incurred (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                        ...
                        if( parseFloat(0+f1.sCost_savings_investment.value) > 0.00 ){
                            ...
                            if( parseFloat(0+f1.sNet_savings.value) > 0.00 ){
                                sStmt = 'Attach Cost calculation sheet for Cost savings & Net Savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            }else{
                                sStmt = 'Attach Cost calculation sheet for Cost savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            ...
                            if( parseFloat(0+f1.sNet_savings.value) > 0.00 ){
                                sStmt = 'Attach Cost calculation sheet for Net Savings (Preferably Pdf and/or jpg)'
                                attach_cost_sheet_after = 'spanNet_savings';
                            }
                        }
                ...
                $('#'+attach_cost_sheet_after).after('<table width="70%" id="tab_attach_cost_sheet">'
                ...
                if( f1.sCall_from.value != 'preScript' && attach_cost_sheet_after != '' ){
                    getPicFlNms('cost');
                }
            ...
            function getPicFlNms(sTyp){
                ...
                if( sTyp != 'all' ){
                    ...
                    if(sTyp == 'bef'){
                        ...
                        document.getElementById("sNoFl_" + iTabNo + '_o').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wp').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wf').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wo').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_pf').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_po').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_fo').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wpf').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wpo').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wfo').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_pfo').value = 0 ;
                        document.getElementById("sNoFl_" + iTabNo + '_wpfo').value = 0 ;
                    }else if(sTyp == 'innovative'){
                        iTabNo = 5;
                    }
                    ...
                    if(PicFlXML.readyState == 4){
                        ...
                        if( sTyp != 'all' ){
                            ...
                            if( sTyp == 'cause' ){
                                ...
                                var sSub_typ = ['w','p','f','o','wp','wf','wo','pf','po','fo','wpf','wpo','wfo','pfo','wpfo','n'];
                                ...
                                for( j = 0 ; j < sSub_typ.length ; j++ ){
                                    ...
                                    for(var i = 1 ; i <= myval.length ; i++){
                                        ...
                                        //td.innerHTML = "<a id='sFlNm_" + iTabNo + "_" + document.getElementById("sNoFl_"+iTabNo).value + "' href='http://10.50.82.60:8181/genorbl/IpicmsUpldPdf/" + cell2 + "' target='_blank'>"+cell1+"</a>";
            ...
            var setDeptCdTmp = function(i){

                document.getElementById("sDeptCdTmp_"+i).value=document.getElementById("sDeptCd_"+i).value;
                return true;
            }
    ...
    <body class="" background="Pics/Order/lblue047.gif" onload="if(f1.sContestId.value == ''){preScript();}else{preScript();}">
        <%
                    ...
                    String sOther_analysis = new String();
                    String sOther_analysis_name = new String();
                    String sNone_analysis = new String();
                    String sNone_analysis_reason = new String();
                    ...
                    String sInnovative_place_work = new String();
                    String sInnovative_place_dept = new String();
                    String sInnovative_place_cesc = new String();
                    String sInnovative_none = new String();
                    String sUniqueness = new String();
                    String sReplicated_from_cesc = new String();
                    String sReplicated_from_oth_industry = new String();
                    String sCompletely_unique = new String();
                    String sUniqueness_remarks = new String();
                    ...
                    String sReplication_in_dept = new String();
                    String sReplication_in_oth_cesc = new String();
                    String sReplication_in_industry = new String();
                    ...
                    String sExpenses_incurred = new String();
                    ...
                    if (sContestId.equals("")) {
                        ...
                        while (iterateOuter.hasNext()) {
                            ...
                            while (iterateInner.hasNext()) {
                                ...
                                sOther_analysis = ((String) iterateInner.next()).trim();
                                sOther_analysis_name = ((String) iterateInner.next()).trim();
                                sNone_analysis = ((String) iterateInner.next()).trim();
                                sNone_analysis_reason = ((String) iterateInner.next()).trim();
                                ...
                                sInnovative_place_work = ((String) iterateInner.next()).trim();
                                sInnovative_place_dept = ((String) iterateInner.next()).trim();
                                sInnovative_place_cesc = ((String) iterateInner.next()).trim();
                                sInnovative_none = ((String) iterateInner.next()).trim();
                                sUniqueness = ((String) iterateInner.next()).trim();
                                sReplicated_from_cesc = ((String) iterateInner.next()).trim();
                                sReplicated_from_oth_industry = ((String) iterateInner.next()).trim();
                                sCompletely_unique = ((String) iterateInner.next()).trim();
                                sUniqueness_remarks = ((String) iterateInner.next()).trim();
                                ...
                                sReplication_in_dept = ((String) iterateInner.next()).trim();
                                sReplication_in_oth_cesc = ((String) iterateInner.next()).trim();
                                sReplication_in_industry = ((String) iterateInner.next()).trim();
                                ...
                                sExpenses_incurred = ((String) iterateInner.next()).trim();
        ...
        <div align="center">
            ...
            <fieldset>
                ...
                <form method="post" action="IpicmsProcessServlet" name="f1" onsubmit="return validate()" >
                    ...
                    <input type="hidden" name="sCall_from" value="">
                    ...
                    <input type="hidden" name="sDeptCdTmp_1" id="sDeptCdTmp_1" value="" />
                    ...
                    <input type="hidden" name="sDeptCdTmp_2" id="sDeptCdTmp_2" value="" />
                    ...
                    <input type="hidden" name="sDeptCdTmp_3" id="sDeptCdTmp_3" value="" />
                    ...
                    <input type="hidden" name="sDeptCdTmp_4" id="sDeptCdTmp_4" value="" />
                    ...
                    <input type="hidden" name="sDeptCdTmp_5" id="sDeptCdTmp_5" value="" />
                    ...
                    <input type="hidden" name="sNoFl_4_o" id="sNoFl_4_o" value="0" />
                    <input type="hidden" name="sNoFl_4_wp" id="sNoFl_4_wp" value="0" />
                    <input type="hidden" name="sNoFl_4_wf" id="sNoFl_4_wf" value="0" />
                    <input type="hidden" name="sNoFl_4_wo" id="sNoFl_4_wo" value="0" />
                    <input type="hidden" name="sNoFl_4_pf" id="sNoFl_4_pf" value="0" />
                    <input type="hidden" name="sNoFl_4_po" id="sNoFl_4_po" value="0" />
                    <input type="hidden" name="sNoFl_4_fo" id="sNoFl_4_fo" value="0" />
                    <input type="hidden" name="sNoFl_4_wpf" id="sNoFl_4_wpf" value="0" />
                    <input type="hidden" name="sNoFl_4_wpo" id="sNoFl_4_wpo" value="0" />
                    <input type="hidden" name="sNoFl_4_wfo" id="sNoFl_4_wfo" value="0" />
                    <input type="hidden" name="sNoFl_4_pfo" id="sNoFl_4_pfo" value="0" />
                    <input type="hidden" name="sNoFl_4_wpfo" id="sNoFl_4_wpfo" value="0" />
                    <input type="hidden" name="sNoFl_4_n" id="sNoFl_4_n" value="0" />
                    <input type="hidden" name="sNoFl_5" id="sNoFl_5" value="0" />
                    ...
                    <input type="hidden" name="hOther_analysis" value="<%= sOther_analysis%>" />
                    <input type="hidden" name="hOther_analysis_name" id="hOther_analysis_name" value="<%= sOther_analysis_name%>" />
                    <input type="hidden" name="hNone_analysis" value="<%= sNone_analysis%>" />
                    <input type="hidden" name="hNone_analysis_reason" id="hNone_analysis_reason" value="<%= sNone_analysis_reason%>" />
                    ...
                    <input type="hidden" name="hInnovative_place_work" id="hInnovative_place_work" value="<%= sInnovative_place_work%>" />
                    <input type="hidden" name="hInnovative_place_dept" id="hInnovative_place_dept" value="<%= sInnovative_place_dept%>" />
                    <input type="hidden" name="hInnovative_place_cesc" id="hInnovative_place_cesc" value="<%= sInnovative_place_cesc%>" />
                    ...
                    <input type="hidden" name="hReplicated_from_cesc" id="hReplicated_from_cesc" value="<%= sReplicated_from_cesc%>" />
                    <input type="hidden" name="hReplicated_from_oth_industry" id="hReplicated_from_oth_industry" value="<%= sReplicated_from_oth_industry%>" />
                    <input type="hidden" name="hCompletely_unique" id="hCompletely_unique" value="<%= sCompletely_unique%>" />
                    <input type="hidden" name="hUniqueness_remarks" id="hUniqueness_remarks" value="<%= sUniqueness_remarks%>" />
                    ...
                    <input type="hidden" name="hReplication_in_dept" id="hReplication_in_dept" value="<%= sReplication_in_dept%>" />
                    <input type="hidden" name="hReplication_in_oth_cesc" id="hReplication_in_oth_cesc" value="<%= sReplication_in_oth_cesc%>" />
                    <input type="hidden" name="hReplication_in_industry" id="hReplication_in_industry" value="<%= sReplication_in_industry%>" />
                    ...
                    <input type="hidden" name="hExpenses_incurred" id="hExpenses_incurred" value="<%= sExpenses_incurred%>" />
                    ...
                    <div id="div_block1">           
                        ...
                        <table class="tab2" width="100%">
                            ...
                            <tr class="thdr">
                                ...
                                <td class="tab2c2" style="width : 20%"><b>Identification of the problem / symptom</b>&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                            </tr>
                            <tr>
                                <td>1
                                ...
                                <td id="dcs1">
                                    ...
                                    <div id="divDept_13" style="width: 100px; background: #FFFFCC ; display : none">
                                        <select name = "sDeptCd_1" id = "sDeptCd_1" onchange="setDeptCdTmp(1);">
                            ...
                            <tr>
                                ...
                                <td id="dcs2">
                                    ...
                                    <div id="divDept_23" style="width: 100px; background: #FFFFCC ; display : none">
                                        <select name = "sDeptCd_2" id = "sDeptCd_2" onchange="setDeptCdTmp(2);">
                            ...
                            <tr>
                                ...
                                <td id="dcs3">
                                    ...
                                    <div id="divDept_33" style="width: 100px; background: #FFFFCC ; display : none">
                                        <select name = "sDeptCd_3" id = "sDeptCd_3" onchange="setDeptCdTmp(3);">
                            ...
                            <tr>
                                ...
                                <td id="dcs4">
                                    ...
                                    <div id="divDept_42" style="width: 100px; background: #FFFFCC ; display : none">
                                        <select name = "sDeptCd_4" id = "sDeptCd_4" onchange="setDeptCdTmp(4);">
                            ...
                            <tr>
                                ...
                                <td id="dcs5">
                                    ...
                                    <div id="divDept_53" style="width: 100px; background: #FFFFCC ; display : none">
                                        <select name = "sDeptCd_5" id = "sDeptCd_5" onchange="setDeptCdTmp(5);">
                    ...
                    <table>
                        <tr>
                            <td width="100%">
                                <div id="div_block2" style="display : none">
                                    ...
                                    <table class="tab3" width="100%">
                                        ...
                                        <tr class="thdr" style="text-align: left;">
                                            <td width="33%">B1. What is the symptom / pain?&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td width="33%">B2. Who is/ are facing the problem ?&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td width="34%">B3. Location of the problem or symptom? Site / machine / process&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr>
                        ...
                        <tr>
                            <td width="100%">
                                <div id="div_block3" style="display : none">
                                    ...
                                    <table class="tab3" width="100%">
                                        ...
                                        <tr class="thdr" style="text-align: left;">
                                            <td width="100%" colspan="2">C1. Improvement aimed at&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: left;"><input type="checkbox" name="sImprove_input" /> Optimisation for Inputs (Man/Mterials)&nbsp;&nbsp;
                                                <input type="checkbox" name="sImprove_methodology" /> Modification of Methods/Practices for the steps&nbsp;&nbsp;
                                                <input type="checkbox" name="sImprove_process_modification" /> Modification of Key steps in the process
                                                <input type="checkbox" name="sImprove_loss_reduction" /> Reduction of loses/wastes(man/material)&nbsp;&nbsp;</td>
                                        </tr>
                                        <tr style="text-align: left;">
                                            <td class="thdr" width="65%" style="text-align: left;">C2. Mention in brief the Primary Root cause as identified to solve the problem&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td class="thdr" width="35%" style="text-align: left;">C5. Picture/ diagram to show problem area (Before Improvement)  (Preferably Pdf and/or jpg)</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="thdr" style="text-align: left;">
                                            <td>C3. Analysis to arrive at root cause(one or more)&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr>
                                            <td width="64%" style="text-align: left"><input type="checkbox" name="sWhy_why_analysis" onclick="clkWhy_why_analysis();"/> Why Why Analysis&nbsp;&nbsp;
                                                <input type="checkbox" name="sPareto_analysis" onclick="clkPareto_analysis();"/> Pareto Analysis&nbsp;&nbsp;
                                                <input type="checkbox" name="sFish_bone_diagram" onclick="clkFish_bone_diagram();"/> Fish Bone Diagram&nbsp;&nbsp;
                                                <input type="checkbox" name="sOther_analysis" onclick="clkOther_analysis();"/> Any Other Problem solving tool&nbsp;&nbsp;
                                                <span id="spanNone_analysis"><input type="checkbox" name="sNone_analysis" id="sNone_analysis" onclick="clkNone_analysis();"/> Use of Tool not applicable</span>
                                            </td>
                                        </tr>
                                        <tr class="thdr" style="text-align: left;">
                                            <td id='td_document_tools'>C4. Attach Analysis document against each of the tools used for analysis (Preferably Pdf and/or jpg)</td>
                                        </tr>
                                        <tr>
                                            <td text-align="left">
                                                <table width="70%">
                        ...
                        <tr>
                            <td width="100%">
                                <div id="div_block4" style="display : none">
                                    ...
                                    <table class="tab3" width="100%">
                                        ...
                                        <tr class="thdr" style="text-align: left">
                                            <td colspan="3">D1. Probable solutions that were thought of&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span>&nbsp;&nbsp;<input type="button" value="Add Row" name="add_row_btn_probable_soln" style="width : 100px ;background-color : #ffffff" onclick="add_row_probable_soln();">&nbsp;&nbsp;<!--input type="button" value="Get Details" name="get_dtls_btn_probable_soln" style="width : 100px ;background-color : #ffffff" onclick="get_dtls_probable_soln();"--></td>
                                            <td width="35%">D2. Picture/Diagram to show application of solution(After Improvement)  (Preferably Pdf and/or jpg)&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr style="text-align: left">
                                            <td colspan="3">
                                                <table class="tab3" width="100%" id="tab_probable_soln">
                                                    <tr style="text-align: left" id="tr_probable_soln_0">
                                                        <td class="thdr" width="50%">Probable Solution&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                                        <td class="thdr" width="40%">Finally implemented Solution&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                                        <td class="thdr" width="10%">Del Row</td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td rowspan="5" id='td_pic_after'>
                                                <table width="70%">
                                                    <!--tr class="thdr">
                                                    ...
                                                    <tr><td colspan="2" style="border : 0pt solid black">&nbsp;</td></tr>
                                                    <tr>
                                                        <td style="border : 0pt solid black ; background-color : #33ccff ; text-align : left" colspan="2">D3. Which Picture to be considered for future ?&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border : 0pt solid black" colspan="2">
                                        ...
                                        <tr class="thdr" style="text-align: left">
                                            <td colspan="3">D4. Considerations for best solution&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="thdr" style="text-align: left">
                                            <td width="33%">D5. Innovativeness&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td width="33%">D6. Uniqueness&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td width="34%">D7. Scope of Replication elsewhere&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr id='tr_D5D6D7'>
                                            <td align="left" valign="top">
                                                <b>First Time at workplace/area of work</b> <br/><input type="radio" name="sInnovative_place_work" value="Y" onclick="clkInnovative_place_work();">Yes <input type="radio" name="sInnovative_place_work" value="N" onclick="clkInnovative_place_work();">No/Not Sure<br/>
                                                <b>First Time within Department/Division</b> <br/><input type="radio" name="sInnovative_place_dept" value="Y" onclick="clkInnovative_place_dept();">Yes <input type="radio" name="sInnovative_place_dept" value="N" onclick="clkInnovative_place_dept();">No/Not Sure<br/>
                                                <input type="checkbox" name="sInnovative_place_cesc" id="sInnovative_place_cesc" onclick="clkInnovative_place_cesc();"/> <b>First Time in CESC/in Industry</b> <br/>
                                                ...
                                                <input type="checkbox" name="sInnovative_none" id="sInnovative_none" onclick="clkInnovative_none();"/> <b>None of the above</b>
                                            </td>
                                            <td align="left" valign="top">
                                                ...
                                                <span id="spanUniqueness_1"><b>Replicated from elsewhere within CESC</b><br/><input type="radio" name="sReplicated_from_cesc" value="Y" onclick="clkReplicated_from_cesc();">Yes <input type="radio" name="sReplicated_from_cesc" value="N" onclick="clkReplicated_from_cesc();">No/Not Sure<br/>
                                                    <b>Replicated from other industry</b><br/><input type="radio" name="sReplicated_from_oth_industry" value="Y" onclick="clkReplicated_from_oth_industry();">Yes <input type="radio" name="sReplicated_from_oth_industry" value="N" onclick="clkReplicated_from_oth_industry();">No/Not Sure<br/>
                                                    <b>Completely new/Unique solution</b><br/><input type="radio" name="sCompletely_unique" value="Y" onclick="clkCompletely_unique();">Yes <input type="radio" name="sCompletely_unique" value="N" onclick="clkCompletely_unique();">No/Not Sure<br/></span>
                                            </td>
                                            <td align="left" valign="top">
                                                ...
                                                <b>Within Same Section/Dept.</b>&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span><br/><input type="radio" name="sReplication_in_dept" value="Y" onclick="">Yes <input type="radio" name="sReplication_in_dept" value="N" onclick="">No/Not Sure<br/>
                                                <b>Within other areas in CESC</b>&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span><br/><input type="radio" name="sReplication_in_oth_cesc" value="Y" onclick="">Yes <input type="radio" name="sReplication_in_oth_cesc" value="N" onclick="">No/Not Sure<br/>
                                                <b>Across Power Industry</b>&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span><br/><input type="radio" name="sReplication_in_industry" value="Y" onclick="">Yes <input type="radio" name="sReplication_in_industry" value="N" onclick="">No/Not Sure
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <tr>
                            <td width="100%">
                                <div id="div_block5" style="display : none">

                                    <table class="tab3" width="100%" id="tab_prfmnce">
                                        <tr class="thdr" style="background-color : #ffcc66">
                                            <td colspan="6">E. Results achieved (Due to this improvement)<br/><br/>(Mention Performance Parameters & Unit of Maasures[UOM])&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span>&nbsp;&nbsp;<input type="button" value="Add Row" name="add_row_btn" style="width : 100px ;background-color : #ffffff" onclick="add_row_prfmnce();">&nbsp;&nbsp;<!--input type="button" value="Get Details" name="add_row_btn" style="width : 100px ;background-color : #ffffff" onclick="get_dtls();"--></td>
                                        </tr>
                                        <tr style="text-align: left" id="tr_prfmnce">
                                            <td class="thdr" width="20%">Item&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td class="thdr" width="20%">Improvement Parameter&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td class="thdr" width="10%">UOM&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td class="thdr" width="20%">Before</td>
                                            <td class="thdr" width="20%">After&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                            <td class="thdr" width="10%">Del Row</td>
                                        </tr>
                                        <tr style="text-align: left" id="tr_benefit_of_improve_continue">
                                            <td colspan="6">
                                                <span id="spanBenefit_of_improve_continue">Benefits of Improvement still continuing ?&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span> <input type="radio" name="sBenefit_of_improve_continue" value="Y" onclick="clkBenefit_of_improve_continue();">Y&nbsp;<input type="radio" name="sBenefit_of_improve_continue" value="N" onclick="clkBenefit_of_improve_continue();">N</span>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <tr>
                            <td width="100%">
                                <div id="div_block6" style="display : none">

                                    <table class="tab3" width="100%" id="tab_prfmnce">
                                        <tr class="thdr" style="background-color : #ffcc66">
                                            <td colspan="3">F. Title of the kaizen&nbsp;<span style="color : red ; font-size : 12pt"><b>*</b></span></td>
                                        </tr>
                                        <tr style="text-align: left">
                                            <td width="20%">
    ...
    animatedcollapse.addDiv('div_block2', 'optional_attribute_string')
    animatedcollapse.addDiv('div_block3', 'optional_attribute_string')
    animatedcollapse.addDiv('div_block4', 'optional_attribute_string')
    animatedcollapse.addDiv('div_block5', 'optional_attribute_string')
    animatedcollapse.addDiv('div_block6', 'optional_attribute_string')
